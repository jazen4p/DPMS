  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Master Data Kode Neraca Saldo</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url()?>Dashboard">Home</a></li>
              <li class="breadcrumb-item active">Kode Neraca Saldo</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                    ...
                    <?php if($this->session->userdata('role') == "superadmin"){?>
                      <div class="col-md-12 card">
                          <div class="card-header">
                            <a href="<?php echo base_url()?>Dashboard/view_neraca_saldo" class="btn btn-flat btn-outline-primary">Set Saldo Awal</a>
                          </div>
                      </div>
                    <?php }?>
                    <div class="col-md-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h4>Kode Induk Neraca Saldo</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form role="form" method="POST" action="<?php echo base_url()?>Dashboard/add_kode_induk_neraca">
                                            <!-- <div class="row"> -->
                                            <div class="form-group">
                                                <label>Jenis</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number"  class="form-control" name="kode_induk">
                                            </div>
                                            <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <!-- form start -->
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form role="form" action="<?php echo base_url()?>Dashboard/add_kode_neraca" method="POST">
                                                <div class="form-group">
                                                    <label>Kode Induk</label>
                                                    <select name="id_induk" class="form-control" required>
                                                        <option value="" disabled selected>-Pilih-</option>
                                                        <?php foreach($kode_induk as $induk){?>
                                                            <option value="<?php echo $induk->id_induk?>"><?php echo $induk->nama_induk?>-<?php echo $induk->no_induk?></option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label>Kode Akun</label>
                                                    <input type="number" class="form-control" name="kode_akun" required>
                                                </div>
                                                <div class="form-group">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example3" class="table table-bordered table-striped" style="font-size: 14px">
                  ...
                  <tbody>
                    <?php $no=1;foreach($kode_anak as $row2){?>
                    <tr>
                      <td><?php echo $no?></td>
                      <td><?php echo $row2->kategori_induk?></td>
                      <td>
                        <?php 
                            foreach($this->db->get_where('akuntansi_induk_akun', array('id_induk'=>$row2->id_induk))->result() as $induk)
                                echo $induk->nama_induk;
                        ?>
                      </td>
                      <td><?php echo $row2->no_akun?></td>
                      <td><?php echo $row2->nama_akun?></td>
                      <td><?php echo $row2->pos?></td>
                      <td>
                        <!-- <a href="<?php echo base_url()?>Dashboard/edit_view_perumahan?id=<?php ?>" class="btn btn-default btn-sm">Edit</a> -->
                        <a href="<?php echo base_url()?>Dashboard/hapus_akun?id=<?php echo $row2->id_akun?>" class="btn btn-default btn-sm">Hapus</a>
                      </td>
                    </tr>
                    <?php $no++;}?>
                  </tbody>
