  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Master Data Daftar Satuan</h1>
          </div>
          <div class="col-sm-6">
    ...
    <?php if(isset($edit_check_all)) {
        ...
        <section class="content">
            ...
            <!-- left column -->
                ...
                <!-- /.card-header -->
                <!-- form start -->
                            <form role="form" action="<?php echo base_url()?>Dashboard/add_edit_daftar_satuan" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="<?php echo base_url()?>Dashboard/produksi_daftar_toko" class="btn btn-primary btn-sm btn-flat">Tambah Baru</a>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <!-- left column -->
                    <div class="col-md-12">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                            <form role="form" action="<?php echo base_url()?>Dashboard/add_produksi_daftar_satuan" method="POST">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                ...
                <table id="example1" class="table table-bordered table-striped" style="font-size: 14px">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url()?>Dashboard/edit_produksi_daftar_satuan?id=<?php echo $row->id_data?>" class="btn btn-default btn-sm">Edit</a>
                        <a href="<?php echo base_url()?>Dashboard/hapus_produksi_daftar_satuan?id=<?php echo $row->id_data?>" class="btn btn-default btn-sm">Hapus</a>
                      </td>
                    </tr>
                    <?php $no++;}?>
                  </tbody>
