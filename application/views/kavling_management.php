                  ...
                  <tbody style="white-space: nowrap">
                    ...
                    <tr>
                        ...
                        <?php if($row->status == "tutup"){
                          ...
                          <td>
                            <button onclick="myFunction(<?php echo $row->id_psjb?>)" class="btn btn-outline-primary btn-flat btn-sm">Approve</button>
                            <a href="<?php echo base_url()?>Dashboard/kavling_view_sendback?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm">Send Back</a>
                            <!-- <a href="<?php echo base_url()?>Dashboard/custom_biaya_psjb?id=<?php echo $row->no_psjb?>" class="btn btn-outline-primary btn-flat btn-sm">Custom</a> -->
                            <span>Menunggu Pimpinan</span>
                            <a href="<?php echo base_url()?>Dashboard/detail_kavling?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm">Detail</a>
                            <a href="<?php echo base_url()?>Dashboard/kavling_batal?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm">Batal</a>
                            <!-- <a href="#" class="btn btn-outline-primary btn-flat btn-sm">Reset</a> -->
                            <!-- <a href="<?php echo base_url()?>Dashboard/print_psjb?id=<?php echo $row->no_psjb?>" class="btn btn-block btn-outline-primary btn-flat btn-sm">Cetak</a> -->
                          </td>
                        <?php } else { ?>
                          <td>
                            <span>Menunggu Pimpinan</span>
                            <a href="<?php echo base_url()?>Dashboard/detail_kavling?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm">Detail</a>
                            <!-- <a href="<?php echo base_url()?>Dashboard/ppjb_batal?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm">Batal</a> -->
                            <!-- <a href="#" class="btn btn-outline-primary btn-flat btn-sm">Reset</a> -->
                            <!-- <a href="<?php echo base_url()?>Dashboard/print_psjb?id=<?php echo $row->no_psjb?>" class="btn btn-block btn-outline-primary btn-flat btn-sm">Cetak</a> -->
                          </td>
                        <?php }} else if($row->status == "revisi"){
                          if($this->session->userdata('role') == "superadmin"){?>
                          <td>
                            <a href="<?php echo base_url()?>Dashboard/kavling_view_revisi?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm">Revisi</a>
                            <!-- <a href="<?php echo base_url()?>Dashboard/custom_biaya_psjb?id=<?php echo $row->no_psjb?>" class="btn btn-outline-primary btn-flat btn-sm">Custom</a> -->
                            <span>Revisi</span>
                            <!-- <a href="<?php echo base_url()?>Dashboard/detail_psjb?id=<?php echo $row->no_psjb?>" class="btn btn-outline-primary btn-flat btn-sm">Detail</a> -->
                            <a href="<?php echo base_url()?>Dashboard/kavling_batal?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm">Batal</a>
                            <!-- <a href="#" class="btn btn-outline-primary btn-flat btn-sm">Reset</a> -->
                            <!-- <a href="<?php echo base_url()?>Dashboard/print_psjb?id=<?php echo $row->no_psjb?>" class="btn btn-block btn-outline-primary btn-flat btn-sm">Cetak</a> -->
                          </td>
                        ...
                        <?php }} else if($row->status == "menunggu"){ 
                          ...
                          <td>
                            ...
                            <a href="<?php echo base_url()?>Dashboard/undo_batal_kavling?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm">Undo Batal</a>
                            <!-- <a href="<?php echo base_url()?>Dashboard/custom_biaya_psjb?id=<?php echo $row->no_psjb?>" class="btn btn-outline-primary btn-flat btn-sm">Custom</a> -->
                            <span>Batal</span>
                            <a href="<?php echo base_url()?>Dashboard/detail_kavling?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm">Detail</a>
                            <!-- <a href="#" class="btn btn-outline-primary btn-flat btn-sm">Reset</a> -->
                        ...
                        <?php }else {?>
                          <td>
                            <a href="<?php echo base_url()?>Dashboard/detail_kavling?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm">Detail</a>
                            <a href="<?php echo base_url()?>Dashboard/print_kavling?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm" target="_blank">Cetak</a>
                            <?php if($row->konsumen_sign == "" && $row->owner_sign == ""){?>
                            ...
                            <?php if($this->session->userdata('role')=="superadmin"){
                              // if($row->lama_penambahan != 0){?>
                              <!-- <a href="<?php echo base_url()?>Dashboard/ppjb_batal?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm">Batal</a> -->
                              <button onclick="myFunction1(<?php echo $row->id_psjb?>)" class="btn btn-outline-primary btn-flat btn-sm">Batal</button>
                              <a href="<?php echo base_url()?>Dashboard/alter_kavling?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-sm btn-flat">Perpanjang</a>
                            <?php }?>
                          </td>
                        <?php }?>
                    </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">PPJB Kavling Online Signature</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="<?php echo base_url()?>Dashboard/update_signature_kavling" method="POST">
          <div class="col-md-12">
...
<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url()?>Dashboard/update_signature_kavling2" method="POST">
          <div class="col-md-12">
            <label class="" for="">Owner signature:</label>
            <br/>
            <div id="sig3"></div>
