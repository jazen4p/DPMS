      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                ...
                <a href="<?php echo base_url()?>Dashboard/print_laba_rugi_rekonsiliasi?id=<?php echo $kode_perumahan?>&min=<?php echo $tglmin?>&max=<?php echo $tglmax?>" class="btn btn-outline-primary btn-flat" target="_blank">PRINT</a>
            </div>
        ...
        <div id="wrapper">
          <form action="<?php echo base_url()?>Dashboard/filter_laba_rugi_rekonsiliasi" method="POST">
            <div class="row">
              <div class="col-md-6">
