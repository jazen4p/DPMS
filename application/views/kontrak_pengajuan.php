    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-9">
            <h1>
                Pencairan Upah Borongan No. <?php echo sprintf('%03d', $row->no_kontrak)?> 
            </h1>
          </div>
          <div class="col-sm-3">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="<?php echo base_url()?>Dashboard/kontrak_management" class="btn btn-info btn-flat btn-sm">Kembali</a>
                </div>
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                      <form action="<?php echo base_url()?>Dashboard/add_pengajuan_borongan" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-12 row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="KBK/KK/<?php echo $row->kode_perumahan.'/'.sprintf('%03d', $row->no_kontrak);?>" readonly>
                                    <input type="hidden" value="<?php echo $row->no_kontrak?>" name="no_kontrak">
                                </div>
                                <div class="form-group">
                                    <label>No Unit</label>
                                    <input type="text" class="form-control" value="<?php echo $row->no_unit?>" name="no_unit" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Tipe Unit</label>
                                    <input type="text" class="form-control" value="<?php echo $row->type_unit?>" name="tipe_unit" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Perumahan</label>
                                    <input type="text" class="form-control" value="<?php echo $row->kode_perumahan?>" name="kode_perumahan" readonly>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>Nama Kontraktor</label>
                                    <input type="text" class="form-control" name="nama_tukang" value="<?php echo $row->nama_tukang?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Keterangan</label>
                                    <input type="text" class="form-control" name="tahap" value="Upah borongan <?php echo $row->kategori?>">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo "Rp. ".number_format($row->nilai_kontrak)?>" readonly>
                                    <input type="hidden" value="<?php echo $row->nilai_kontrak?>" id="totalPencairan" name="harga_jual">
                                </div>
                                <?php $ttl_k = 0; foreach($this->db->get_where('kbk_pencairan_kontrak', array('id_kontrak'=>$row->id_kontrak))->result() as $cair){
                                    $ttl_k = $ttl_k + $cair->nominal;
                                }?>
                                <div class="form-group">
                                    <label>Pencairan Yang Telah Dicairkan</label>
                                    <input type="number" name="" class="form-control" id="akanPencairan" value="<?php echo $ttl_k?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Sisa Akumulasi Pencairan</label>
                                    <input type="number" name="nominal_awal" class="form-control" id="sisaAkumulasiPencairan" value="<?php echo $row->nilai_kontrak - $ttl_k?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Nominal Pencairan</label>
                                    <input type="number" name="nominal" class="form-control" id="nominalPencairan" required>
                                </div>
                                <div class="form-group">
                                    <label>Sisa Pencairan</label>
                                    <input type="text" class="form-control" id="sisaPencairanShow" value="NaN" readonly>
                                    <input type="hidden" id="sisaPencairan" name="nominal_akhir">
                                </div>
                            </div>
                        </div>
                    </div>  
