...
?>
    <?php foreach($penerimaan_lain as $row){?>
      <div id="header">
      <?php 
   ...
   <div id="content">
             ...
             <table style="padding-left: 40px">
                 <tbody>
                    <tr>
                        ...
                        <th>:</th>
                        <th><?php echo $row->terima_dari?></th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th>:</th>
                        <th><?php echo terbilang($row->dana_terima)?> Rupiah</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th>
                          <?php 
                          echo $row->keterangan;
                          if($row->kategori == "ground tank" || $row->kategori == "tambahan bangunan"){
                            echo " Unit ".$row->kode_rumah." ".$perumahan->nama_perumahan;
                          }?>
                        </th>
                    </tr>
                 </tbody>
     ...
     <p>
        <table style="width: 100%; table-layout: fixed">
          <tr>
            ...
            <td style="text-align: center">
              <?php ?>
              Pontianak, <?php echo date('d', strtotime($row->tanggal_dana))." ".ubahBulan(date('M', strtotime($row->tanggal_dana)))." ".date('Y', strtotime($row->tanggal_dana))?>
              <?php ?>
            </td>
          </tr>
          <tr>
        ...
        <!-- <span style="width: 120px; border: 1px solid; padding-left: 15px;padding-right: 15px;padding-top: 15px;padding-bottom: 15px; margin: 20px; margin-left: 40px; font-size: 18px; font-weight: bold">Rp. <?php echo number_format($row->dana_terima)?></span>
