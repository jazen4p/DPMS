              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-striped" style="font-size: 13px">
                  ...
                  <div id="wrapper" style="">
                    <form action="<?php echo base_url()?>Dashboard/filter_ppjb_management" method="POST">
                    Perumahan:
                    ...
                    <tr>
                        ...
                        <?php if($row->status == "tutup"){
                          ...
                          <td>
                            ...
                            <a href="<?php echo base_url()?>Dashboard/ppjb_view_sendback?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm">Send Back</a>
                            ...
                            <a href="<?php echo base_url()?>Dashboard/detail_ppjb?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm">Detail</a>
                        ...
                        <?php }} else if($row->status == "revisi"){
                          if($this->session->userdata('role') == "superadmin"){?>
                          <td>
                            <a href="<?php echo base_url()?>Dashboard/ppjb_view_revisi?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm">Revisi</a>
                            <!-- <a href="<?php echo base_url()?>Dashboard/custom_biaya_psjb?id=<?php echo $row->no_psjb?>" class="btn btn-outline-primary btn-flat btn-sm">Custom</a> -->
                            <span>Revisi</span>
                        ...
                        <?php }} else if($row->status == "menunggu"){ 
                          ...
                          <td>
                            ...
                            <a href="<?php echo base_url()?>Dashboard/undo_batal_ppjb?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm">Undo Batal</a>
                            <!-- <a href="<?php echo base_url()?>Dashboard/custom_biaya_psjb?id=<?php echo $row->no_psjb?>" class="btn btn-outline-primary btn-flat btn-sm">Custom</a> -->
                            <span>Batal</span>
                            <a href="<?php echo base_url()?>Dashboard/detail_ppjb?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm">Detail</a>
                            <!-- <a href="#" class="btn btn-outline-primary btn-flat btn-sm">Reset</a> -->
                        ...
                        <?php }else {?>
                          <td>
                            <a href="<?php echo base_url()?>Dashboard/detail_ppjb?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm">Detail</a>
                            <a href="<?php echo base_url()?>Dashboard/print_ppjb?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm" target="_blank">Cetak</a>
                            <?php if($row->marketing_sign == "" && $row->konsumen_sign == "" && $row->owner_sign == ""){?>
                            ...
                            <?php } else if($row->owner_sign == ""){
                              if($this->session->userdata('role')=="superadmin"){?>
                              <button type="button" id="signature" class="btn btn-flat btn-sm btn-outline-primary" data-toggle="modal" data-target="#exampleModal2" data-id="<?php echo $row->id_psjb?>">Signature</button>
                            <?php }}?>
                            ...
                            <?php if($this->session->userdata('role')=="superadmin"){
                              ...
                              <a href="<?php echo base_url()?>Dashboard/alter_ppjb?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-sm btn-flat">Perpanjang</a>
                            <?php }?>
                          </td>
                        <?php }?>
                    </tr>
