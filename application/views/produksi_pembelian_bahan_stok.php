                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                ...
                                <a class="btn btn-success btn-flat btn-sm" href="<?php echo base_url()?>Dashboard/rekap_arus_stok?id=<?php echo $kode_perumahan?>">Kembali</a>
                            </div>
                            <?php echo form_open_multipart('Dashboard/add_pembelian_bahan_stok');?>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?php echo $nama_toko?>" name="toko_bangunan" class="form-control" readonly required>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="kode_perumahan" value="<?php echo $kode_perumahan?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                ...
                                <!-- <div id="mainKredit"> -->
                                <?php $no=1; foreach($id_brg as $row){
                                    foreach($this->db->get_where('logistik_arus_stok', array('id_arus'=>$row))->result() as $brg){?>
                                    <hr>
                                    <div class="row">
                                      ...
                                      <div class="col-md-11 row">
                                          <div class="form-group col-md-3">
                                              ...
                                              <select class="form-control" id="namaBahan<?php echo $no?>" name="nama_bahan[]" required>
                                                  <option value="" disabled selected>-Pilih-</option>
                                                  <?php foreach($barang->result() as $barangs) {
                                                      echo "<option ";
                                                      if($brg->nama_barang == $barangs->nama_data){
                                                          echo "selected";
                                                      }
                                                      echo " value='$barangs->nama_data'>$barangs->nama_data</option>";
                                                  }?>
                                              </select>
                                          </div>
                                          <div class="form-group col-md-2">
                                              <label>Qty</label>
                                              <input type="number" name="qty[]" class="form-control" id="qty<?php echo $no?>" value="<?php echo $brg->qty?>" required>
                                          </div>
                                          <div class="form-group col-md-2">
                                              <label>Satuan</label>
                                              <input type="text" class="form-control" id="response<?php echo $no?>" name="satuan[]" value="<?php echo $brg->nama_satuan?>" readonly required>
                                          ...
                                          <div class="form-group col-md-2">
                                              ...
                                              <input type="number" class="form-control" name="harga_satuan[]" id="hargaSatuan<?php echo $no?>" required>
                                          </div>
                                          <div class="form-group col-md-3">
                                              <label>Total</label>
                                              <input type="number" class="form-control" id="total<?php echo $no?>" value="0" readonly>

                                              <input type="hidden" value="<?php echo $row?>" name="id_arus[]">
                                          </div>
                                      </div>
                                    </div>
                                <?php }
                                  ?>
                                    <div class="row">
                                      ...
                                      <div class="col-sm-10 row">
                                        ...
                                        <div class="form-group col-md-3">
                                              <label>Nama Bahan</label>
                                              <input type="text" readonly class="form-control" id="namaBahan1<?php echo $no?>" name="nama_bahan1[]" value="<?php echo $brg->nama_barang?>" required>
                                                  <!-- <option value="" disabled selected>-Pilih-</option>
                                                  <?php foreach($barang->result() as $barangs) {
                                                      echo "<option ";
                                                      if($brg->nama_barang == $barangs->nama_data){
                                          ...
                                          <div class="form-group col-md-2">
                                              <label>Qty</label>
                                              <input type="number" readonly name="qty1[]" class="form-control" id="qty1<?php echo $no?>" value="<?php echo $brg->qty?>" required>
                                          </div>
                                          <div class="form-group col-md-2">
                                              <label>Satuan</label>
                                              <input type="text" class="form-control" id="response1<?php echo $no?>" name="satuan1[]" value="<?php echo $brg->nama_satuan?>" readonly required>
                                              <!-- <select name="satuan[]" class="form-control" required>
                                                  <option value="" disabled selected>-Pilih-</option>
                                                  <?php foreach($satuan->result() as $satuans){?>
                                                      <option value="<?php echo $satuans->nama_data?>"><?php echo $satuans->nama_data?></option>
                                          ...
                                          <div class="form-group col-md-2">
                                              <label>Harga Satuan</label>
                                              <input type="number" class="form-control" name="harga_satuan1[]" id="hargaSatuan1<?php echo $no?>" required>
                                          </div>
                                          <div class="form-group col-md-3">
                                              <label>Total</label>
                                              <input type="number" class="form-control" id="ttl1<?php echo $no?>" value="0" readonly>
                                ...
                                <div class="col-md-12 row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <input type="text" id="ttlAll" class="form-control" readonly>
                                    </div>
                                </div>
...
<script type="text/javascript">
  ...
  $('#hargaSatuan').on('input', function(){
    ...
    $(function () {
        ...
        (function (x) {
            $('#qty'+x).on("input", function () {
                ...
                $('#total'+x).val(qty*hargaSatuan);

                var sum = 0;
                $("input[id^='total']").each(function(){
                    sum += +$(this).val();
                });
                $("#ttlAll").val(numberWithCommas(sum));
            });
        })(x);
        }
    });
    ...
    $(function () {
        ...
        for (var y = 1; y <= check; y++) {
        (function (y) {
            $("#namaBahan"+y).change(function(){
                var selectedCountry = $(this).val();
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url()?>Dashboard/get_satuan",
    ...
    $(function () {
        ...
        for (var z = 1; z <= check; z++) {
        (function (z) {
            $('#hargaSatuan'+z).on("input", function () {
                var qty = $(this).val();
                var hargaSatuan = $('#qty'+z).val();

                $('#total'+z).val(qty*hargaSatuan);
    ...
    $(function () {
        ...
        for (var z = 1; z <= check; z++) {
        (function (z) {
            $('#hargaSatuan1'+z).on("input", function () {
                var qty = $(this).val();
                var hargaSatuan = $('#qty1'+z).val();

                $('#ttl1'+z).val(qty*hargaSatuan);
