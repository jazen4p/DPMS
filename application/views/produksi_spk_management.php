          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a href="<?php echo base_url()?>Dashboard/view_spk_management" class="btn btn-outline-success btn-flat btn-sm">Kembali</a>
                <?php if($this->session->userdata('role')=="superadmin"){?>
                  <a href="<?php echo base_url()?>Dashboard/view_add_spk_management?id=<?php echo $id?>" class="btn btn-outline-info btn-flat btn-sm">Tambah Baru</a>
                <?php }?>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if($row->staff_sign == ""){?>
                              <button type="button" id="signature" class="btn btn-flat btn-sm btn-outline-primary" data-toggle="modal" data-target="#exampleModal" data-id="<?php echo $row->id_spk?>">Signature</button>
                              <a href="<?php echo base_url()?>Dashboard/spk_detail?id=<?php echo $row->id_spk?>" class="btn btn-outline-primary btn-flat btn-sm">Detail</a>
                              <a href="<?php echo base_url()?>Dashboard/print_spk?id=<?php echo $row->id_spk?>" class="btn btn-outline-primary btn-flat btn-sm" target="_blank">Cetak</a>
                            <?php } else {
                              $dt = $this->db->get_where('kbk', array('id_spk'=>$row->id_spk));
                              if($dt->num_rows() < 1){?>
                                <a href="<?php echo base_url()?>Dashboard/kbk_form?id=<?php echo $row->id_spk?>" class="btn btn-outline-primary btn-flat btn-sm">Daftarkan KBK</a>
                                <?php if($this->session->userdata('role')=="superadmin"){?>
                                  <a href="<?php echo base_url()?>Dashboard/view_revisi_spk?id=<?php echo$row->id_spk?>" class="btn btn-outline-primary btn-flat btn-sm">Revisi</a>
                                <?php }?>
                              <?php } else {
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url()?>Dashboard/update_signature_spk" method="POST">
          <div class="col-md-12">
