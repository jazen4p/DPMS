          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <form role="form" action="<?php echo base_url()?>Dashboard/update_detail_psjb?id=<?php echo $row->id_psjb?>" method="post" enctype="multipart/form-data">
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control" type="date" value="<?php echo $row->tanggal_dana?>" readonly>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
              ...
              <div class="card-footer">
                <div class="row">
                  <a href="<?php echo base_url()?>Dashboard/detail_psjb?id=<?php echo $row->no_psjb?>&kode=<?php echo $row->kode_perumahan?>"/ class="btn btn-success btn-sm">Kembali</a>
                </div>
                <!-- /.row -->
              </div>
              <!-- /.card-footer -->
