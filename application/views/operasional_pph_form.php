                  ...
                  <div class="col-md-12">
                      ...
                      <!-- /.card-header -->
                        <div class="card-header">
                            <a class="btn btn-info btn-sm btn-flat" href="<?php echo base_url()?>Dashboard/list_pph">Kembali</a>
                            <br>
                            <?php if(isset($succ_msg)){
                      ...
                      <!-- form start -->
                          <!-- <form role="form" action="<?php echo base_url()?>Dashboard/add_pengeluaran" method="post" enctype="multipart/form-data"> -->
                          <?php echo form_open_multipart('Dashboard/add_pengeluaran_pph');?>
                              <div class="card-body">
                                  <div class="row">
                                      <div class="col-md-3">
                                          <div class="form-group">
                                      ...
                                      <div class="col-md-3">
                                          ...
                                          <div class="form-group">
                                              <label>Tanggal Pengeluaran</label>
                                              <input type="date" class="form-control" placeholder="" name="tgl_pengeluaran" value="<?php echo $tgl_bayar_pajak?>" required>
                                          </div>
                                      </div>
