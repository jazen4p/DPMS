                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="white-space: nowrap">
                                        <a href="<?php echo base_url()?>Dashboard/buku_besar_rekonsiliasi?id=<?php echo $row->kode_perusahaan?>" class="btn btn-outline-primary btn-flat btn-sm" target="_blank">Buka</a>
                                    </td>
                                </tr>
                                <?php $no++;}?>
                            </tfoot>
