                ...
                <!-- form start -->
                    ...
                    <div class="card-body">
                        <div class="row">
                                        ...
                                        <?php foreach($this->db->get('rumah')->result() as $row){?>
                                            ...
                                            <?php if($row->status == "free"){ 
                                                foreach($kavling as $row2){
                                                    ...
                                                    <option value="<?php echo $row->kode_rumah?>"><?php echo $row->kode_rumah?>-<?php echo $row->nama_perumahan?></option>
                                            <?php }}}?>
                                        <?php }?>
                                        </select>
                                    <?php } else{?>
                            ...
                            <form role="form" action="<?php echo base_url()?>Dashboard/tambah_unit" onsubmit="myFunction()" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Nomor Kavling Yang Telah Dipesan</label>
                        ...
                        <div class="row">
                            <table class="table">
                                    ...
                                    <td>
                                        <select class="form-control" name="bank_awal" required>
                                            ...
                                            <?php foreach($this->db->get('bank')->result() as $row3){?>
                                                <option value="<?php echo $row3->nama_bank?>"><?php echo $row3->nama_bank?></option>
                                            <?php }?>
                                        </select>
                                        <span>Pilihan bank saat ini: <?php echo $row->nama_bank?></span>
                                    </td><td></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                         <input type="number" class="form-control" id="nominalTotal" value="<?php echo $row->total_jual?>" readonly/>   
                                    </td>
                                </tr>
                            </table>
                        </div>
            ...
            <div class="col-md-12">
                ...
                <!-- /.card-header -->
                    <div class="card-header">
                        <a href="<?php echo base_url()?>Dashboard/psjb_management" class="btn btn-flat btn-sm btn-success">Kembali</a>
                    </div>
                <!-- form start -->
                <?php foreach($psjbs as $psjb){?>
                    <section class="content-header">
                        <div class="container-fluid">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            <form role="form" action="<?php echo base_url()?>Dashboard/get_kavling_tambah_unit" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Nomor Kavling</label>
                                    <?php if(isset($kavling)){?>
                                        <select class="form-control" id="id_kavling" placeholder="Nomor Kavling" name="id_kavling" required>
                                        <?php foreach($this->db->get_where('rumah', array('kode_perumahan'=>$psjb->kode_perumahan, 'tipe_produk'=>"rumah"))->result() as $row){?>
                                            <!-- <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Nomor Kavling" name="nomor_kavling" required> -->
                                            <?php if($row->status == "free"){ 
                                                foreach($kavling as $row2){
                                                    if($row2->kode_rumah == $row2->kode_rumah){?>
                                    ...
                                    <?php }?>
                                    <input type="hidden" name="id" value="<?php echo $psjb->id_psjb?>">
                                    <input type="hidden" name="no_psjb" value="<?php echo $psjb->no_psjb?>">
                                    <input type="submit" value="ok" class="btn btn-flat btn-sm btn-outline-primary">
                                    <?php if(isset($kavling)){ foreach($kavling as $row){?>
                                        Pilihan sekarang: <input type="text" value="<?php echo $row->kode_rumah."-".$row->nama_perumahan?>" readonly required>
                                    <?php }} else {
                                        echo "<input type='text' readonly required>";
                                    }?>
                                    <br>
                                    Kavling yang telah terdaftar: <?php echo $psjb->no_kavling?><?php
                                    foreach($this->db->get_where('rumah', array('no_psjb'=>$psjb->no_psjb, 'tipe_produk'=>$row->tipe_produk, 'kode_perumahan'=>$row->kode_perumahan))->result() as $rumah){
                            ...
                            <form role="form" action="<?php echo base_url()?>Dashboard/add_tambah_unit_psjb" onsubmit="return myFunction()" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nama Perusahaan</label>
                                    <?php if(isset($kavling)){ foreach($kavling as $row){?>
                                    ...
                                    <?php }} else{?>
                                        <input type="text" class="form-control" placeholder="Nama Perusahaan" value="<?php echo $nama_perusahaan?>" required readonly>
                                    <?php }?>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nama Perumahan</label>
                                    ...
                                    <?php }} else{?>
                                        <input type="text" class="form-control" placeholder="Nama Perumahan" value="<?php echo $psjb->perumahan?>" required readonly>
                                    <?php }?>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nama Marketing</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nama Marketing" name="nama_marketing" value="<?php echo $psjb->nama_marketing?>">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Nama Pemesan</label>
                                    <input type="text" class="form-control" id="inputNamaPemesan" placeholder="Nama Pemesan" name="nama_pemesan" value="<?php echo $psjb->nama_pemesan?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Nama Dalam Sertifikat/PPJB</label>
                                    <input type="text" class="form-control" id="inputNamaSertifikat" placeholder="Nama Dalam Sertifikasi/PPJB" name="nama_sertif" value="<?php echo $psjb->nama_sertif?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Alamat Lengkap</label>
                                    <textarea class="form-control" id="exampleInputPassword1" placeholder="Alamat Lengkap" name="alamat_lengkap" required><?php echo $psjb->alamat_lengkap?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Alamat Surat</label>
                                    <textarea class="form-control" id="exampleInputPassword1" placeholder="Alamat Surat" name="alamat_surat" required><?php echo $psjb->alamat_surat?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">No Telp Rumah</label>
                                    <input type="number" class="form-control" id="exampleInputEmail1" placeholder="No Telp Rumah" name="no_telp" value="<?php echo $psjb->telp_rumah?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">No Handphone</label>
                                    <input type="number" class="form-control" id="exampleInputEmail1" placeholder="No Handphone" name="no_hp" value="<?php echo $psjb->telp_hp?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">No KTP</label>
                                    <input type="number" class="form-control" id="exampleInputEmail1" placeholder="No KTP" name="ktp" value="<?php echo $psjb->ktp?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Pekerjaan</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Pekerjaan" name="pekerjaan" value="<?php echo $psjb->pekerjaan?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmailNPWP">NPWP</label>
                                    <input type="text" class="form-control" id="exampleInputEmailNPWP" placeholder="No. NPWP" name="npwp" value="<?php echo $psjb->npwp?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmailEmail">E-mail</label>
                                    <input type="email" class="form-control" id="exampleInputEmailEmail" placeholder="E-mail" name="email" value="<?php echo $psjb->email?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Uang Tanda Jadi</label>
                                    <input type="number" class="form-control" id="tandaJadi1" placeholder="Tanda Jadi" name="uang_awal" value="<?php echo $psjb->uang_awal?>" required>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <?php if(isset($kavling)){
                                    foreach($kavling as $row){?>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Luas Tanah m<sup>2</sup></label>
                                            <input type="number" class="form-control" id="luas_tanah" placeholder="Luas Tanah" name="luas_tanah" value="<?php echo $row->luas_tanah+$psjb->luas_tanah?>" required readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Luas Bangunan m<sup>2</sup></label>
                                            <input type="number" class="form-control" id="luas_bangunan" placeholder="Luas Bangunan" name="luas_bangunan" value="<?php echo $row->luas_bangunan+$psjb->luas_bangunan?>" required readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Tipe Standart</label>
                                            <input type="number" class="form-control" id="tipe_standart" placeholder="Tipe Standart" name="tipe_standart" value="<?php echo $row->tipe_rumah+$psjb->tipe_rumah?>" required readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Harga Jual Standart (Rp)</label>
                                            <input type="number" class="form-control" id="myInput3" placeholder="0" name="harga_jual_standart" value="<?php echo $row->harga_jual+$psjb->harga_jual?>" required readonly>
                                        </div>
                                <?php }} else {?>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Luas Tanah m<sup>2</sup></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <span>Cara pembayaran saat ini: <?php echo $psjb->sistem_pembayaran?></span>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Hadap Timur</label>
                                    <!-- <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Cara Pembayaran" name="cara_pembayaran" required> -->
                                    <input type="number" class="form-control" id="hadapTimur" placeholder="" name="hadap_timur" value="<?php echo $psjb->hadap_timur?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Diskon Penjualan (Rp)</label>
                                    <input type="number" class="form-control" id="myInput1" placeholder="0" name="diskon_penjualan" value="<?php echo $psjb->disc_jual?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Total Penjualan (Rp)</label>
                                    <input type="number" class="form-control" id="myInput2" placeholder="NaN" name="total_penjualan" value="<?php echo $row->harga_jual+$psjb->harga_jual+$psjb->hadap_timur-$psjb->disc_jual?>" readonly>
                                    <!-- <input type="number" id="myInput1" />
                                    <input type="number" id="myInput2" /> -->
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Catatan Pembayaran</label>
                                    <!-- <input type="text" class="form-control" id="exampleInputPassword1" placeholder="No Telp" name="telp"> -->
                                    <textarea  class="form-control" id="exampleInputPassword1" placeholder="Catatan Pembayaran" name="catatan"><?php echo $psjb->catatan?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nama Pemesan</label>
                                    <input type="text" class="form-control" id="namaPemesan" placeholder="" value="<?php echo $psjb->nama_pemesan?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Hadap Timur</label>
                                    <input type="number" class="form-control" id="hadapTimurBayar" placeholder="" value="<?php echo $psjb->hadap_timur?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nama Sertifikat</label>
                                    <input type="text" class="form-control" id="namaSertifikat" placeholder="" value="<?php echo $psjb->nama_sertif?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Diskon</label>
                                    <!-- <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Cara Pembayaran" name="cara_pembayaran" required> -->
                                    <input type="number" class="form-control" id="diskon" placeholder="" value="<?php echo $psjb->disc_jual?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Harga Sepakat</label>
                                    <!-- <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Cara Pembayaran" name="cara_pembayaran" required> -->
                                    <input type="number" class="form-control" id="hargaSepakat" placeholder="" value="<?php echo $row->harga_jual+$psjb->harga_jual+$psjb->hadap_timur-$psjb->disc_jual?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Tipe Pembayaran</label>
                                    <input type="text" class="form-control" id="tipePembayaran" placeholder="" value="<?php echo $psjb->sistem_pembayaran?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Tanda Jadi</label>
                                    <input type="number" class="form-control" id="tandaJadi" placeholder="" value="<?php echo $psjb->uang_awal?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Total Kekurangan Rencana Bayar</label>
                                    <input type="number" class="form-control" id="totalKekuranganRencanaBayar" placeholder="" value="<?php echo $row->harga_jual+$psjb->harga_jual+$psjb->hadap_timur-$psjb->disc_jual-$psjb->uang_awal?>" readonly>
                                </div>
                                <!-- <div class="form-group">
                                    <label for="exampleInputPassword1">Biaya Kekurangan</label>
                                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Cara Pembayaran" name="cara_pembayaran" required>
                                    <input type="number" class="form-control" id="biayaKekurangan" placeholder="" value="<?php echo $row->harga_jual+$psjb->harga_jual+$psjb->hadap_timur-$psjb->disc_jual-$psjb->uang_awal?>" readonly>
                                </div> -->
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="date" class="form-control" id="tanggalJadiPembayaran" value="<?php echo $psjb->tgl_psjb?>" readonly/>
                                    </td>
                                    <td>
                                        <?php if(isset($kavling)){?>
                                            <span>Pembayaran BFee saat ini: <?php echo $psjb->nama_bank?></span>
                                        <?php } else {?>
                                            <select class="form-control" name="bank_awal" required>
                                                <option disabled selected value="">-Pilih-</option>
                                                <?php foreach($this->db->get('bank')->result() as $row3){?>
                                    ...
                                    <td></td>
                                    <td>
                                        <input type="number" class="form-control" id="tandaJadiPembayaran" value="<?php echo $psjb->uang_awal?>" readonly/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>2.</td>
                                    ...
                                    <td>
                                        ...
                                        <input type="number" class="form-control" id="persenDP" name="persenDP" placeholder="<?php echo $psjb->persen_dp?>" required/>
                                        <span>Persen DP saat ini:<?php echo $psjb->persen_dp?></span>
                                    </td>
                                    <td>
                                        <input type="date" class="form-control" name="tglDP" value="<?php echo $psjb->tgl_dp?>" required/>
                                    </td>
                                    <td>
                                        <select class="form-control" id="caraDP" name="caraDP" required>
                                            <option disabled selected value="">-Pilih-</option>
                                        ...
                                        <span>Cara bayar saat ini:<?php echo $psjb->cara_dp?></span>
                                    </td>
                                    <td>
                                        <div id="cicil" class="formLamaDP" style="display:none">
                                            <select class="form-control" id="lamaDP" name="lamaDP">
                                        ...
                                        <?php if($psjb->cara_dp == "cicil"){?>
                                            <span>Cicilan dp saat ini: <?php echo $psjb->jumlah_dp?></span>
                                        <?php }?>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="date" class="form-control" name="tglKPR" value="<?php echo $psjb->tgl_kpr?>" required/>
                                    </td>
                                    <td>
                                        <!-- <select class="form-control">
                                            <option>Cicil</option>
                                    ...
                                    <td>
                                        <div id="Tempo" class="formLamaTempo" style="display:none">
                                            ...
                                            <span>Lama cicil saat ini: <?php echo $psjb->lama_tempo?></span>
                                        </div>
                                        <div id="Cash" class="formLamaCash" style="display:none">
                                            <select class="form-control" name="lama_cash" required>
                                                <!-- <option disabled selected>-Pilih-</option> -->
                                            ...
                                            <span>Lama cicil saat ini: <?php echo $psjb->lama_cash?></span>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" class="form-control" id="persenBunga" name="persen_bunga" required readonly value="<?php echo $psjb->persen_bunga?>"/>
                                    </td>
                                    <td>
                    ...
                    <div class="card-footer">
                        ...
                        <!-- <input type="hidden" name="id" value="<?php echo $psjb->no_psjb?>"> -->
                        <input type="hidden" name="id_psjb" value="<?php echo $psjb->id_psjb?>">
                        <input type="hidden" name="no_psjb" value="<?php echo $psjb->no_psjb?>">
                        <input type="submit" class="btn btn-primary" value="Submit" />
                    </div>
                    </form>
...
<script type="text/javascript">
  ...
  persenDP.addEventListener('input', function(){
    totalDP.value = (hargaSepakat.value * persenDP.value)/100;
  ...
  tandaJadi1.addEventListener('input', function() {
    ...
    // hargaSepakat.value = parseInt(input3.value) + parseInt(hadapTimur.value) - input1.value;
    totalKekuranganRencanaBayar.value = hargaSepakat.value - diskon.value - tandaJadi.value;
    // biayaKekurangan.value = hargaSepakat.value - tandaJadi.value;
...
function myFunction() {
  ...
  var r = confirm("Anda akan menetapkan PSJB ini ditutup kembali?");
  if (r) {
    // window.alert("This post was successfully deleted.");
    
    // window.location.href = "https://google.com";
    window.location.replace(base_url+"/add_tambah_unit_psjb");
  } else {
    return false;
  }
//   if (r == true) {
