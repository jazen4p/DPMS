      ...
      <div class="card">
        ...
        <form role="form" method="POST" action="<?php echo base_url()?>Kasir/add_air_belum_tinggal" enctype="multipart/form-data">
            ...
            <div class="col-sm-12 row">
              <!-- <div class="col-sm-3">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" value="70000">
                </div>
              </div> -->
              <div class="col-sm-12">
          ...
          <div class="card-footer" style="text-align: left">
            <!-- <input type="submit" class="btn btn-success btn-sm" value="Buat Tagihan Maintenance Bulan Ini"> -->
          </div>
                  ...
                  <tbody style="white-space: nowrap">
                    <?php foreach($check_all->result() as $row2){?>
                        <tr <?php if($row2->status == "lunas"){echo "style='background-color: lightgreen'";} else {echo "style='background-color: pink'";}?>>
                            ...
                            <td><?php echo $row2->meteran?> m<sup>2</sup></td>
                            <td><?php echo $row2->penggunaan_air?> m<sup>2</sup></td>
