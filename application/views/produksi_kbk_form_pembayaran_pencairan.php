                  ...
                  <div class="col-md-12">
                      ...
                      <!-- /.card-header -->
                        <div class="card-header">
                            <a class="btn btn-info btn-sm btn-flat" href="<?php echo base_url()?>Dashboard/kbk_pencairan_dana_management?id=<?php echo $kode?>">Kembali</a>
                            <br>
                            <?php if(isset($succ_msg)){
                      ...
                      <!-- form start -->
                          <!-- <form role="form" action="<?php echo base_url()?>Dashboard/add_pengeluaran" method="post" enctype="multipart/form-data"> -->
                          <?php echo form_open_multipart('Dashboard/add_pencairan_nominal');?>
                              <div class="card-body">
                                  <div class="row">
                                      <div class="col-md-3">
                                          <div class="form-group">
