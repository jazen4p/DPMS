              ...
              <!-- left column -->
                  <div class="col-md-12">
                      ...
                      <!-- /.card-header -->
                          <div class="card-header">
                              <!-- <a class="btn btn-info btn-sm btn-flat" href="<?php echo base_url()?>Dashboard/ppjb_management">Kembali</a> -->
                            <a href="<?php echo base_url()?>Dashboard/kbk_pencairan_dana_harian_management" class="btn btn-success btn-flat btn-sm">Kembali</a>
                            <?php if(isset($succ_msg)){?>
                              <br>    
                              <span style='color: green'><?php echo $succ_msg?></span>
                            <?php }?>
                          ...
                          <?php echo form_open_multipart('Dashboard/add_kontrak_kerja_harian');?>
                              <div class="card-body">
                                  <div class="row">
                                      <div class="col-md-6">
                                          <!-- <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <select name="kategori" class="form-control" id="cat" required>
                                              <option value="" disabled selected>-Pilih-</option>
                                          ...
                                          <div id="unit" class="kategori" style="display: none">
                                            <div class="form-group">
                                              <label>Unit</label>
                                              <select name="unit" class="form-control" id="resp" required>
                                          ...
                                          <div id="" class="">
                                            <div class="form-group">
                                              ...
                                              <textarea class="form-control" name="kontrak_pekerjaan" id="saranaT" required></textarea>
                                            </div>
                                          </div>
                                          <!-- <div class="form-group">
                                              <label>No. Unit</label>
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          <label>Upah (Rp.)</label>
                                          <input type="number" id="upah" class="form-control" name="upah" required>
                                        </div>
                                        <div class="form-group">
                                          <label>Masa Kerja (Hari)</label>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="number" id="lembur" name="lembur" class="form-control" value="0" required>
                                        </div>
                                        <div class="form-group">
                                          <label>Total</label>
                                      ...
                                      <!-- <div class="col-md-4">
                                        <div class="form-group">
                                          <label>Tanggal Mulai</label>
                                          <input type="date" id="tglMulai" name="tgl_mulai" class="form-control">
                                        </div>
                                        <div class="form-group">
                                          <label>Tanggal Selesai</label>
                                          <input type="date" id="tglSelesai" name="tgl_selesai" class="form-control">
                                        </div>
                                      </div> -->
                                  </div>
                              </div>
...
$(document).ready(function(){
    ...
    $('#cat').change(function(){
      ...
      if($(this).val() == "unit"){
        $('#saranaT').removeAttr('required');
        $('#resp').attr('required', 'required');
      } else if($(this).val() == "sarana") {
        $('#resp').removeAttr('required');
        $('#saranaT').attr('required', 'required');
      }
    })
});
...
$(document).ready(function () {
    ...
    $('#upah').on("input", function(){
      ...
      var ttl = (parseInt(upah)*parseInt(masaKerja));
      var ttl2 = parseInt(ttl) + parseInt(lembur);

      $('#total').val(ttl2);
    })

    $('#masaKerja').on("input", function(){
      var upah = $('#upah').val();
      var masaKerja = $(this).val();
      var lembur = $('#lembur').val();
