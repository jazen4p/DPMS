              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <table class="table">
                        <tbody>
                            <tr><td>Nomor PSJB</td><td>1-<?php echo $row->no_psjb?>/PPJB/KBR/<?php echo $row->kode_perusahaan."/".$row->kode_perumahan."/".date("m", strtotime($row->tgl_psjb))."/".date("Y", strtotime($row->tgl_psjb))?></td></tr>
                  ...
                  <form role="form" action="<?php echo base_url()?>Dashboard/kavling_sendback?id=<?php echo $row->id_psjb?>" method="post" enctype="multipart/form-data">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <table class="table">
