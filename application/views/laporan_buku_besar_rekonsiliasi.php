  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <div id="wrapper">
          <form action="<?php echo base_url()?>Dashboard/filter_laporan_buku_besar_rekonsiliasi" method="POST">
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="card-body">
                ...
                <table id="example2" class="table table-bordered table-striped" style="font-size: 13px;">
                  ...
                  <div class="form-group row">
                    ...
                    <input type="hidden" value="<?php echo $kode_perusahaan?>" id="kodePerusahaan">
                  </div>
                  <div class="row">
...
<script>
  ...
  $("select.namaAkun").change(function(){
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url()?>Dashboard/get_buku_besar_rekonsiliasi",
        data: { country : selectedCountry, kodePerusahaan: kodePerusahaan, start: start, end: end } 
    }).done(function(data){
        $("#response").html(data);
    });
  });
