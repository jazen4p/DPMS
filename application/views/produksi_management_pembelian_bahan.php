  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Informasi Pembelian Bahan</h1>
          </div>
          <div class="col-sm-6">
                    ...
                    <?php $no=1; foreach($check_all->result() as $row){?>
                        <tr>
                            ...
                            <td>
                              <?php 
                                $arr = array();
                                foreach($this->db->get_where('produksi_transaksi', array('no_faktur'=>$row->no_faktur))->result() as $brg){
                                  $gt = $this->db->get_where('logistik_arus_stok', array('id_arus'=>$brg->id_arus));
                                  // print_r($gt->num_rows());
                                  if($gt->num_rows() == 0){
                            ...
                            <td>
                                ...
                                <?php if($this->session->userdata('role')=="superadmin" || $this->session->userdata('role')=="manager keuangan"){?>
                                  <a href="<?php echo base_url()?>Dashboard/hapus_pembelian_bahan?id=<?php echo $row->no_faktur?>&ids=<?php echo $row->id_transaksi?>" class="btn btn-outline-primary btn-flat btn-sm">Hapus</a>
                                <?php }?>
                            </td>
                        </tr>
                    <?php $no++;}?>
