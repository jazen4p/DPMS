...
<body>
    <div class="container-fluid">
     ...
     <a class="btn btn-sm btn-success btn-flat" href="<?php echo base_url()?>Kasir/export_tagihan_diajukan?bln=<?php echo $bln?>&kode=<?php echo $kode_perumahan?>"><i class="fa fa-file"></i> Export Data</a>
