      ...
      <div class="container-fluid">
                ...
                <div class="col-sm-12 row">
                  ...
                  <div class="col-sm-9">
                    <div class="row">
                      ...
                      <!-- <div class="col-sm-4">
                        <a href="<?php echo base_url()?>Dashboard/hapus_all_tagihan_maintenance?bln=" class="btn btn-success btn-sm">Hapus Tagihan Bulan Ini</a>
                      </div> -->
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="<?php echo base_url()?>Kasir/edit_all_maintenance" method="POST" enctype="multipart/form-data">
                  ...
                  <tbody style="white-space: nowrap">
                    <?php foreach($get_all->result() as $row2){?>
                        <tr <?php if($row2->status == "lunas"){echo "style='background-color: lightgreen'";} else {echo "style='background-color: pink'";}?>>
                            ...
                            <td>
                              <?php echo "Rp. ".number_format($row2->nominal)?>
                              <?php if($row2->status == "belum lunas"){?>
                                <input type="number" value="<?php echo $row2->nominal?>" name="nominal[]">

                                <input type="hidden" value="<?php echo $row2->id_maintenance?>" name="id_maintenance[]">
                              <?php }?>
                            </td>
