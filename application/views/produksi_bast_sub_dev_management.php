    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>
              BAST Sub Kontraktor - Developer Management 
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">BAST Sub - Dev</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a href="<?php echo base_url()?>Dashboard/bast_sub_dev_management_perumahan" class="btn btn-outline-success btn-flat btn-sm">Kembali</a>
                <a href="<?php echo base_url()?>Dashboard/view_add_bast_sub_dev?id=<?php echo $id?>" class="btn btn-outline-info btn-flat btn-sm">Tambah Baru</a>
                  ...
                  <tbody style="white-space: nowrap">
                    <?php foreach($check_all->result() as $gt){
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo base_url()?>Dashboard/print_bast_sub_dev?id=<?php echo $gt->id_bast?>" target="_blank" class="btn btn-outline-primary btn-flat btn-sm">Cetak</a>
                            <a href="<?php echo base_url()?>Dashboard/hapus_bast_sub_dev?id=<?php echo $gt->id_bast?>&kode=<?php echo $id?>" class="btn btn-outline-primary btn-flat btn-sm">Hapus</a>
                          </td>
                        </tr>
                    <?php }}?>
                  </tfoot>
