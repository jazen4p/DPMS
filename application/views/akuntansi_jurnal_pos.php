        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">POST Jurnal</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header">
              <div class="row">
                <div class="col-md-8">
                  <a href="<?php echo base_url()?>Dashboard/informasi_jurnal_akuntansi" class="btn btn-sm btn-success btn-flat">Kembali</a>
          ...
          <form role="form" method="POST" action="<?php echo base_url()?>Dashboard/add_pos_jurnal" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-12">
                <div class="card-footer">
                  <input type="hidden" value="<?php echo $row->kategori?>" name="jenis_keuangan">
                  <input type="hidden" value="<?php echo $row->id_jurnal?>" name="id">
                  <input type="hidden" value="<?php echo $row->kode_perumahan?>" name="kode_perumahan">
                  <input type="hidden" value="<?php echo $row->tgl_jurnal?>" name="tgl_jurnal">
