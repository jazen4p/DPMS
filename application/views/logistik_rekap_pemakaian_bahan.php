    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>
              Rekap Pemakaian Bahan
            </h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url()?>Dashboard">Home</a></li>
              <li class="breadcrumb-item active">Rekap Pemakaian Bahan</li>
            </ol>
          </div>
        </div>
          ...
          <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="<?php echo base_url()?>Dashboard/view_rekap_pemakaian_bahan" class="btn btn-outline-success btn-sm btn-flat">Kembali</a>
                </div>
                <div class="card-body">
                    <div class="col-12">
                        <table id="example2" class="table table-bordered table-striped" style="font-size: 14px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $no;?></td>
                                    <td style="white-space: nowrap"><?php echo $row->unit?></td>
                                    <td style="white-space: nowrap"><?php echo $nama_perumahan?></td>
                                    <td style="white-space: nowrap">
                                        <a href="<?php echo base_url()?>Dashboard/rekap_pemakaian_perunit?id=<?php echo $row->id_kbk?>&kode=<?php echo $id?>" class="btn btn-outline-primary btn-flat btn-sm">Buka</a>
                                    </td>
                                </tr>
                                <?php $no++;}
                                  foreach($k_kawasan as $row1){
                                    ?>
                                    <tr>
                                      <td><?php echo $no;?></td>
                                      <td style="white-space: nowrap"><?php echo $row1->nama?></td>
                                      <td style="white-space: nowrap"><?php echo $nama_perumahan?></td>
                                      <td style="white-space: nowrap">
                                          <a href="<?php echo base_url()?>Dashboard/rekap_pemakaian_perkawasan?id=<?php echo $row1->id_kawasan?>&kode=<?php echo $id?>" class="btn btn-outline-primary btn-flat btn-sm">Buka</a>
                                      </td>
                                    </tr>
                                  <?php $no++;}
                                ?>
