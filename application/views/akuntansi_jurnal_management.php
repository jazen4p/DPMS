          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-header">
                <a href="<?php echo base_url()?>Dashboard/add_jurnal_akuntansi" class="btn btn-info btn-flat btn-sm">Tambah Baru</a>
              </div>
              <div class="card-body">
                    ...
                    <tbody>
                        <?php foreach($check_all->result() as $row){?>
                            <tr>
                                ...
                                <td>
                                    <?php 
                                        $q = $this->db->get_where('akuntansi_pos_jurnal', array('id_keuangan'=>$row->id_jurnal));
                                        if($q->num_rows() > 0){
                                    ?>
                                        <a href="<?php echo base_url()?>Dashboard/pos_jurnal?id=<?php echo $row->id_jurnal?>" class="btn btn-outline-primary btn-flat btn-sm">POST REVISI</a>
                                    <a href="<?php echo base_url()?>Dashboard/detail_jurnal?id=<?php echo $row->id_jurnal?>" class="btn btn-outline-primary btn-sm btn-flat">Detail</a>
                                    <?php } else {?>
                                        <a href="<?php echo base_url()?>Dashboard/pos_jurnal?id=<?php echo $row->id_jurnal?>" class="btn btn-outline-primary btn-flat btn-sm">POST</a>
                                    <?php }?>
                                    <a href="<?php echo base_url()?>Dashboard/hapus_jurnal?id=<?php echo $row->id_jurnal?>" class="btn btn-outline-primary btn-sm btn-flat">Batal</a>
                                </td>
                            </tr>
                        <?php }?>
                    </tbody>
