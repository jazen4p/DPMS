    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>
              Set Neraca Saldo Awal
            </h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url()?>Dashboard">Home</a></li>
              <li class="breadcrumb-item active">Set Neraca Saldo Awal</li>
            </ol>
          </div>
        </div>
          ...
          <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                  <a href="<?php echo base_url()?>Dashboard/akun_neraca_saldo" class="btn btn-outline-success btn-sm btn-flat">Kembali</a>
              </div>
                <div class="card-body">
                    <div class="col-12">
                        <table id="" class="table table-bordered table-striped" style="font-size: 14px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="white-space: nowrap"><?php echo $row->nama_perumahan?></td>
                                    <td style="white-space: nowrap">
                                        <?php 
                                            $query = $this->db->get_where('keuangan_neraca_saldo_awal', array('kode_perumahan'=>$row->kode_perumahan));
                                            if($query->num_rows() > 10){?>
                                                <a class="btn btn-outline-info btn-sm btn-flat" href="<?php echo base_url()?>Dashboard/view_edit_neraca_saldo_awal?id=<?php echo $row->id_perumahan?>">Edit Skema</a>
                                            <?php } else {
                                        ?>
                                            <a class="btn btn-default btn-sm btn-flat" href="<?php echo base_url()?>Dashboard/view_add_neraca_saldo_awal?id=<?php echo $row->id_perumahan?>">Tambah Skema</a>
                                        <?php }?>
                                    </td>
                                </tr>
                                <?php $no++;}?>
