                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="white-space: nowrap">
                                        <?php 
                                            $query = $this->db->get_where('keuangan_kontrol_budget', array('kode_perumahan'=>$row->kode_perumahan));
                                            if($query->num_rows() > 10){?>
                                                <a class="btn btn-outline-info btn-sm btn-flat" href="<?php echo base_url()?>Dashboard/view_edit_kontrol_budget?id=<?php echo $row->id_perumahan?>">Edit Skema</a>
                                                <a class="btn btn-outline-info btn-sm btn-flat" href="<?php echo base_url()?>Dashboard/cek_budget?id=<?php echo $row->id_perumahan?>">Cek Budget</a>
                                            <?php } else {
                                        ?>
                                            <a class="btn btn-default btn-sm btn-flat" href="<?php echo base_url()?>Dashboard/view_add_kontrol_budget?id=<?php echo $row->id_perumahan?>">Tambah Skema</a>
                                        <?php }?>
                                    </td>
                                </tr>
                                <?php $no++;}?>
