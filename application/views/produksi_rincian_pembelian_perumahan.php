        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Rincian Pembelian Bahan</li>
            </ol>
          </div>
        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="white-space: nowrap">
                                        <a href="<?php echo base_url()?>Dashboard/rincian_pembelian?id=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm" target="_blank">Buka</a>
                                    </td>
                                </tr>
                                <?php $no++;}?>
                            </tfoot>
