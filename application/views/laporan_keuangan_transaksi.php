  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <form action="<?php echo base_url()?>Dashboard/filter_laporan_keuangan_transaksi" method="POST">
          <div class="row">
            ...
            <input placeholder="Tanggal Awal" name="tgl_awal" value="<?php if(isset($tglmin)){echo $tglmin;}?>" class="textbox-n form-control col-sm-2" type="text" onfocus="(this.type='date')" id="date">
            <input placeholder="Tanggal Akhir" name="tgl_akhir" value="<?php if(isset($tglmax)){echo $tglmax;}?>" class="textbox-n form-control col-sm-2" type="text" onfocus="(this.type='date')" id="date">
            <div>
            <input type="submit" class="btn btn-info btn-flat" value="FILTER" />
            <a href="<?php echo base_url()?>Dashboard/print_laporan_keuangan_transaksi?kode=" class="btn btn-info btn-flat" style="">CETAK</a>
            </div>
          </div>
        </form>
                ...
                <table id="" class="table table-bordered table-striped" style="font-size: 14px">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <?php foreach($this->db->get_where('ppjb', array('no_psjb'=>$row->no_ppjb))->result() as $ppjb ) {
                          echo "<td>".$ppjb->nama_pemesan."</td>";
                          echo "<td>".$ppjb->no_kavling."</td>";
                        }?>
                        <td><?php echo $row->nama_bank?></td>
                        <td><?php echo "1-".$row->no_ppjb;?></td>
                        ...
                        <?php 
                          ...
                          // }
                        ?>
                        <td>Rp. <?php echo number_format($row->pembayaran)?></td>
                    </tr>
                    <?php $no++;}?>
                  </tfoot>
                </table>
