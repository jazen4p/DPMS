  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Detail POS Akuntansi Jurnal</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-header">
                <a href="<?php echo base_url()?>Dashboard/informasi_jurnal_akuntansi" class="btn btn-success btn-flat btn-sm">Kembali</a>
