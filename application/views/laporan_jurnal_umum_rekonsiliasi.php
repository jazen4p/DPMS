  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <div id="wrapper">
          <form action="<?php echo base_url()?>Dashboard/filter_jurnal_umum_rekonsiliasi" method="POST">
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="card-body">
                ...
                <table id="example2" class="table table-bordered table-striped" style="font-size: 12px;">
                  ...
                  <tbody style="white-space: nowrap">
                    <?php $no=1;
                      $arr = array(); 
                      // $check_all = $this->db->get('')
                      foreach($this->db->get_where('perumahan', array('kode_perusahaan'=>$id))->result() as $chq){
                        $check_all = $this->Dashboard_model->get_jurnal_umum($start, $end, $chq->kode_perumahan);
