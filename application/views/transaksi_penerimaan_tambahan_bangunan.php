  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Penerimaan Tambahan Bangunan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url()?>Dashboard">Home</a></li>
              <li class="breadcrumb-item active">Penerimaan Tambahan Bangunan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
    <?php if(isset($edit_tambahan_bangunan)) {
        foreach($edit_tambahan_bangunan->result() as $row){?>
                    ...
                    <div class="col-md-12">
                        ...
                        <!-- form start -->
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <form role="form" action="<?php echo base_url()?>Dashboard/edit_update_tambahan_bangunan" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="<?php echo base_url()?>Dashboard/penerimaan_tambahan_bangunan" class="btn btn-primary">Tambah Baru</a>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <!-- form start -->
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <form role="form" action="<?php echo base_url()?>Dashboard/penerimaan_tambahan_bangunan_perumahan" method="POST">
                                                <div class="row">
                                            ...
                                            <form role="form" action="<?php echo base_url()?>Dashboard/add_tambahan_bangunan" method="post" enctype="multipart/form-data">
                                            
                                            <?php if(isset($penerimaan_lain_perumahan)){?>
                                                <div class="form-group">
                                                    <label>No Kwitansi</label>
                                                    <input type="text" class="form-control" placeholder="No Kwitansi" name="no_kwitansi" value="<?php echo $no_kwitansi?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Kode Perumahan</label>
                                                    <input type="text" class="form-control" placeholder="" name="kode_perumahan" value="<?php echo $kode_perumahan?>" readonly>
                                                </div>
                                            <?php } else {?>
                                                <div class="form-group">
                                                    <label>No Kwitansi</label>
                                                    <input type="text" class="form-control" placeholder="No Kwitansi" name="no_kwitansi" value="" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Kode Perumahan</label>
                                                    <input type="text" class="form-control" placeholder="" name="kode_perumahan" value="" readonly>
                                                </div>
                                            <?php }?>
                                        </div>
                                        <div class="col-md-4">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <button type="button" id="button" class="btn btn-flat btn-info">FILTER</button>
                  <form action="<?php echo base_url()?>Dashboard/filter_tambahan_bangunan" method="POST">
                ...
                <table id="example2" class="table table-bordered table-striped" style="font-size: 13px; white-space: nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url()?>Dashboard/edit_tambahan_bangunan?id=<?php echo $row->id_keuangan?>" class="btn btn-default btn-sm">Edit</a>
                        <a href="<?php echo base_url()?>Dashboard/hapus_tambahan_bangunan?id=<?php echo $row->id_keuangan."&kode=".$row->kode_perumahan?>" class="btn btn-default btn-sm">Hapus</a>
