      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                ...
                <a href="<?php echo base_url()?>Dashboard/print_neraca?id=<?php echo $kode_perumahan?>&min=<?php echo $tglmin?>&max=<?php echo $tglmax?>" class="btn btn-outline-primary btn-flat" target="_blank">PRINT</a>
            </div>
        ...
        <div id="wrapper">
          <form action="<?php echo base_url()?>Dashboard/filter_neraca" method="POST">
            <div class="row">
              <div class="col-md-6">
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <input type="hidden" value="<?php echo number_format($ttl1+$ttl2);?>" id="aktiva">
                <input type="hidden" value="<?php echo number_format($ttl3+$ttl4);?>" id="passiva">
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
