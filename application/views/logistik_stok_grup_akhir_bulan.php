          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-header">
                  <a href="<?php echo base_url()?>Dashboard/stok_bahan?id=<?php echo $id?>" class="btn btn-outline-success btn-sm btn-flat">Kembali</a>
                  <a href="<?php echo base_url()?>Dashboard/view_add_check_stok_baru?id=<?php echo $id?>" class="btn btn-outline-success btn-sm btn-flat">Tambah Baru</a>
                    ...
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php $no=1; foreach($check_all->result() as $row){?>
                              <tr>
                                <td><?php echo $no?></td>
                                <td><?php echo date('F Y', strtotime($row->bulan_cek));?></td>
                                <td>
                                  <a href="<?php echo base_url()?>Dashboard/view_edit_check_stok_baru?id=<?php echo $id?>&kode=<?php echo date('Y-m-d', strtotime($row->bulan_cek))?>" class="btn btn-default btn-flat btn-sm">Edit</a>
                                  <a href="<?php echo base_url()?>Dashboard/hapus_check_stok_baru?id=<?php echo $id?>&kode=<?php echo date('Y-m', strtotime($row->bulan_cek))?>" class="btn btn-default btn-flat btn-sm">Hapus</a>
                                </td>
                              </tr>
                            <?php $no++;}?>
                        </tbody>
