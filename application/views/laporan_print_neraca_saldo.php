        ...
        <div style="text-align: center">
            ...
            <table id="example2" class="table table-bordered table-striped" style="font-size: 12px;">
              ...
              <tbody style="white-space: nowrap">
                ...
                <?php $ttl1=0;foreach($this->db->get_where('akuntansi_induk_akun', array('no_induk'=>""))->result() as $induk){?>
                    <?php foreach($this->db->get_where('keuangan_neraca_saldo_awal', array('id_induk'=>$induk->id_induk, 'kode_perumahan'=>$kode_perumahan))->result() as $modal){?>
                    <tr style="background-color: lightblue">
                      ...
                      //   ?>
                          <?php 
                      //   foreach($this->Dashboard_model->laba_rugi_pos_jurnal($modal->no_akun, $kode_perumahan, "", $tglmin, "koreksi")->result() as $sld){
                      ...
                      //   }
                      //   foreach($this->Dashboard_model->laba_rugi_pos_jurnal($modal->no_akun, $kode_perumahan, "", $tglmin, "penyesuaian")->result() as $sld1){
                      ...
                      <?php $ttl_awal = 0; $db=0; $kr=0;  $kr_jrl=0; $db_jrl=0;
                      if(isset($tgl_awal)){
                        $ttl_awal = $modal->nominal;
                      } else {
                        if($tglmin != ""){
                          foreach($this->Dashboard_model->laba_rugi_saldo_awal($modal->no_akun, $kode_perumahan, $tglmin)->result() as $awal){
                          ...
                          <?php 
                          $ttl_sld=0; $kr_jrl1 = 0; $db_jrl1 = 0;
                          foreach($this->Dashboard_model->laba_rugi_saldo_awal_jurnal($modal->no_akun, $kode_perumahan, $tglmin, "koreksi")->result() as $sld){
                            if($sld->pos_akun == "kredit"){
                              $kr_jrl = $kr_jrl + $sld->nominal;
                            } else if($sld->pos_akun == "debet") {
                              $db_jrl = $db_jrl + $sld->nominal;
                          ...
                          foreach($this->Dashboard_model->laba_rugi_saldo_awal_jurnal($modal->no_akun, $kode_perumahan, $tglmin, "penyesuaian")->result() as $sld1){
                            if($sld1->pos_akun == "kredit"){
                              $kr_jrl1 = $kr_jrl1 + $sld1->nominal;
                            } else if($sld1->pos_akun == "debet") {
                              $db_jrl1 = $db_jrl1 + $sld1->nominal;
                      ...
                      <?php $ttl_mdl_awal = 0; $db=0; $kr=0;
                      foreach($this->Dashboard_model->perubahan_modal($modal->no_akun, $kode_perumahan, $tglmin, $tglmax)->result() as $prb_mdl){
                      ...
                      <?php 
                      $total_jr=0; $db=0; $kr=0; $total_jr2=0; $db1=0; $kr1=0; 
                      ?>

                      <?php foreach($this->Dashboard_model->laba_rugi_pos_jurnal($modal->no_akun, $kode_perumahan, $tglmin, $tglmax, "koreksi")->result() as $jrnl){
                      ...
                      <?php foreach($this->Dashboard_model->laba_rugi_pos_jurnal($modal->no_akun, $kode_perumahan, $tglmin, $tglmax, "penyesuaian")->result() as $jrnl){
                        if($jrnl->pos_akun == "kredit"){
                      ...
                      <td style="background-color: lightblue"><?php echo "Rp. ".number_format($total_jr);?></td>
                      <td style="background-color: lightblue"><?php echo "Rp. ".number_format($total_jr2);?></td>
                      <td style="background-color: lightblue"><?php echo "Rp. ".number_format($ttl_awal + $ttl_mdl_awal + $total_jr + $total_jr2);?></td>
                    </tr>
                    <?php $ttl1 = $ttl1 + $ttl_awal + $ttl_mdl_awal + $total_jr + $total_jr2;}?>
                <?php }?>

                <?php $ttl2=0;foreach($this->db->get_where('akuntansi_induk_akun', array('no_induk'=>"1"))->result() as $induk2){?>
                    <?php foreach($this->db->get_where('keuangan_neraca_saldo_awal', array('id_induk'=>$induk2->id_induk, 'kode_perumahan'=>$kode_perumahan))->result() as $modal1){?>
                    <tr style="background-color: lightblue">
                      <td style="background-color: lightblue" style="background-color: lightblue"><?php echo $modal1->no_akun?></td>
                      <td style="background-color: lightblue" style="background-color: lightblue"><?php echo $modal1->nama_akun?></td>
                      <td style="background-color: lightblue" style="background-color: lightblue">AWAL</td>
                      <td style="background-color: lightblue" style="background-color: lightblue"><?php echo $modal1->pos?></td>
                      <?php $ttl_awal1 = 0; $db=0; $kr=0; $kr_jrl1 = 0; $db_jrl1 = 0; $kr_jrl=0; $db_jrl=0;
                      if(isset($tgl_awal)){
                        $ttl_awal1 = $modal1->nominal;                              
                      } else {
                        if($tglmin != ""){
                          foreach($this->Dashboard_model->laba_rugi_saldo_awal($modal1->no_akun, $kode_perumahan, $tglmin)->result() as $awal1){
                          ...
                          foreach($this->Dashboard_model->laba_rugi_pos_jurnal($modal1->no_akun, $kode_perumahan, "", $tglmin, "koreksi")->result() as $sld){
                            if($sld->pos_akun == "kredit"){
                              $kr_jrl = $kr_jrl + $sld->nominal;
                            } else if($sld->pos_akun == "debet") {
                              $db_jrl = $db_jrl + $sld->nominal;
                          ...
                          foreach($this->Dashboard_model->laba_rugi_pos_jurnal($modal1->no_akun, $kode_perumahan, "", $tglmin, "penyesuaian")->result() as $sld1){
                            if($sld1->pos_akun == "kredit"){
                              $kr_jrl1 = $kr_jrl1 + $sld1->nominal;
                            } else if($sld1->pos_akun == "debet") {
                              $db_jrl1 = $db_jrl1 + $sld1->nominal;
                      ...
                      <?php $ttl_mdl_awal1 = 0; $db=0; $kr=0;
                      foreach($this->Dashboard_model->perubahan_modal($modal1->no_akun, $kode_perumahan, $tglmin, $tglmax)->result() as $prb_mdl1){
                        if($prb_mdl1->pos_akun == "kredit"){
                          $kr = $kr + $prb_mdl1->nominal;
                        } else if($prb_mdl1->pos_akun == "debet"){
                          $db = $db + $prb_mdl1->nominal;
                        }
                      }
                      if($modal1->pos == "Kredit"){
                        $ttl_mdl_awal1 = $ttl_mdl_awal1 + $kr - $db;
                      } else if($modal1->pos == "Debet"){
                        $ttl_mdl_awal1 = $ttl_mdl_awal1 + $db - $kr;
                      }?>
                      <td style="background-color: lightblue">
                      ...
                      <?php foreach($this->Dashboard_model->laba_rugi_pos_jurnal($modal1->no_akun, $kode_perumahan, $tglmin, $tglmax, "koreksi")->result() as $jrnl){
                        if($jrnl->pos_akun == "kredit"){
                          $kr = $kr + $jrnl->nominal;
                        } else if($jrnl->pos_akun == "debet") {
                          $db = $db + $jrnl->nominal;
                      ...
                      <?php foreach($this->Dashboard_model->laba_rugi_pos_jurnal($modal1->no_akun, $kode_perumahan, $tglmin, $tglmax, "penyesuaian")->result() as $jrnl){
                        if($jrnl->pos_akun == "kredit"){
                          $kr1 = $kr1 + $jrnl->nominal;
                        } else if($jrnl->pos_akun == "debet") {
                          $db1 = $db1 + $jrnl->nominal;
                      ...
                      <td style="background-color: lightblue"><?php echo "Rp. ".number_format($total_jr);?></td>
                      <td style="background-color: lightblue"><?php echo "Rp. ".number_format($total_jr2);?></td>
                      <td style="background-color: lightblue"><?php echo "Rp. ".number_format($ttl_awal1 + $ttl_mdl_awal1 + ($ttl_sld + $total_jr + $total_jr2));?></td>
                    </tr>
                  <?php $ttl2 = $ttl2 + $ttl_awal1 + $ttl_mdl_awal1 + ($ttl_sld + $total_jr + $total_jr2); }?>
                <?php }?>
                
                <tr style="background-color: lightblue; font-weight: bold">
                  <td style="background-color: lightblue; text-align: center;" colspan=8>TOTAL AKTIVA</td>
                  <td style="background-color: lightblue;"><?php echo "Rp. ".number_format($ttl1+$ttl2);?></td>
                </tr>
                ...
                <?php $ttl3 = 0; $ttl4=0; foreach($this->db->get_where('akuntansi_induk_akun', array('no_induk'=>"21000"))->result() as $induk3){?>
                    <?php foreach($this->db->get_where('keuangan_neraca_saldo_awal', array('id_induk'=>$induk3->id_induk, 'kode_perumahan'=>$kode_perumahan))->result() as $psv1){?>
                    <tr style="background-color: pink">
                        <td style="background-color: pink"><?php echo $psv1->no_akun?></td>
                        <td style="background-color: pink"><?php echo $psv1->nama_akun?></td>
                        <td style="background-color: pink">AWAL</td>
                        <td style="background-color: pink"><?php echo $psv1->pos?></td>
                        <?php $ttl_awal2 = 0; $db=0; $kr=0; $kr_jrl1 = 0; $db_jrl1 = 0; $kr_jrl=0; $db_jrl=0;
                        if(isset($tgl_awal)){
                          $ttl_awal2 = $psv1->nominal;
                        } else {
                          if($tglmin != ""){
                            foreach($this->Dashboard_model->laba_rugi_saldo_awal($psv1->no_akun, $kode_perumahan, $tglmin)->result() as $awal2){
                            ...
                            foreach($this->Dashboard_model->laba_rugi_pos_jurnal($psv1->no_akun, $kode_perumahan, "", $tglmin, "koreksi")->result() as $sld){
                              if($sld->pos_akun == "kredit"){
                                $kr_jrl = $kr_jrl + $sld->nominal;
                              } else if($sld->pos_akun == "debet") {
                                $db_jrl = $db_jrl + $sld->nominal;
                            ...
                            foreach($this->Dashboard_model->laba_rugi_pos_jurnal($psv1->no_akun, $kode_perumahan, "", $tglmin, "penyesuaian")->result() as $sld1){
                              if($sld1->pos_akun == "kredit"){
                                $kr_jrl1 = $kr_jrl1 + $sld1->nominal;
                              } else if($sld1->pos_akun == "debet") {
                                $db_jrl1 = $db_jrl1 + $sld1->nominal;
                        ...
                        <?php $ttl_mdl_awal2 = 0; $kr=0; $db=0;
                        foreach($this->Dashboard_model->perubahan_modal($psv1->no_akun, $kode_perumahan, $tglmin, $tglmax)->result() as $prb_mdl2){
                          if($prb_mdl2->pos_akun == "kredit"){
                            $kr = $kr + $prb_mdl2->nominal;
                          } else if($prb_mdl2->pos_akun == "debet"){
                            $db = $db + $prb_mdl2->nominal;
                          }
                        }
                        if($psv1->pos == "Kredit"){
                          $ttl_mdl_awal2 = $ttl_mdl_awal2 + $kr - $db;
                        } else if($psv1->pos == "Debet"){
                          $ttl_mdl_awal2 = $ttl_mdl_awal2 + $db - $kr;
                        }?>
                        <td style="background-color: pink">
                      ...
                      // if($tglmin != ""){
                        ...
                        <?php foreach($this->Dashboard_model->laba_rugi_pos_jurnal($psv1->no_akun, $kode_perumahan, $tglmin, $tglmax, "koreksi")->result() as $jrnl){
                          if($jrnl->pos_akun == "kredit"){
                            $kr = $kr + $jrnl->nominal;
                          } else if($jrnl->pos_akun == "debet") {
                            $db = $db + $jrnl->nominal;
                        ...
                        <?php foreach($this->Dashboard_model->laba_rugi_pos_jurnal($psv1->no_akun, $kode_perumahan, $tglmin, $tglmax, "penyesuaian")->result() as $jrnl){
                          if($jrnl->pos_akun == "kredit"){
                            $kr1 = $kr1 + $jrnl->nominal;
                          } else if($jrnl->pos_akun == "debet") {
                            $db1 = $db1 + $jrnl->nominal;
                        ...
                        <td style="background-color: pink"><?php echo "Rp. ".number_format($total_jr);?></td>
                        <td style="background-color: pink"><?php echo "Rp. ".number_format($total_jr2);?></td>
                        <td style="background-color: pink"><?php echo "Rp. ".number_format($ttl_awal2 + $ttl_mdl_awal2 + ($ttl_sld + $total_jr + $total_jr2));?></td>
                    </tr>
                      ...
                      <!-- <tr>
                        ...
                        <?php 
                          ...
                          foreach($ts->result() as $akun){?>
                            ...
                            <?php $total=0; $db=0; $kr=0; foreach($this->Dashboard_model->laba_rugi_pos($akun->no_akun, $kode_perumahan, "", $tglmin)->result() as $pos){
                            ...
                            <?php $total_jr=0; $db1=0; $kr1=0; foreach($this->Dashboard_model->laba_rugi_pos_jurnal($akun->no_akun, $kode_perumahan, "", $tglmin, "koreksi")->result() as $jrnl){
                              if($jrnl->pos_akun == "kredit"){
                                $kr1 = $kr1 + $jrnl->nominal;
                              } else if($jrnl->pos_akun == "debet") {
                                $db1 = $db1 + $jrnl->nominal;
                            ...
                            <?php $total_jr2=0; $db1=0; $kr1=0; foreach($this->Dashboard_model->laba_rugi_pos_jurnal($akun->no_akun, $kode_perumahan, "", $tglmin, "penyesuaian")->result() as $jrnl){
                              if($jrnl->pos_akun == "kredit"){
                                $kr1 = $kr1 + $jrnl->nominal;
                              } else if($jrnl->pos_akun == "debet") {
                                $db1 = $db1 + $jrnl->nominal;
                            ...
                            $total_jr1=0; $db1=0; $kr1=0; foreach($this->Dashboard_model->laba_rugi_pos_jurnal($akun->no_akun, $kode_perumahan, "", $tglmin, "penutup")->result() as $jrnl){
                              if($jrnl->pos_akun == "kredit"){
                                $kr1 = $kr1 + $jrnl->nominal;
                              } else if($jrnl->pos_akun == "debet") {
                                $db1 = $db1 + $jrnl->nominal;
                    ...
                    <?php foreach($this->db->get_where('akuntansi_anak_akun', array('id_induk'=>$row->id_induk))->result() as $anak){?>
                        <!-- <tr>
                            ...
                            foreach($ts->result() as $akun){?>
                                ...
                                <?php $total_jr1=0; $db1=0; $kr1=0; foreach($this->Dashboard_model->laba_rugi_pos_jurnal($akun->no_akun, $kode_perumahan, "", $tglmin, "penutup")->result() as $jrnl){
                                  if($jrnl->pos_akun == "kredit"){
                                    $kr1 = $kr1 + $jrnl->nominal;
                                  } else if($jrnl->pos_akun == "debet") {
                                    $db1 = $db1 + $jrnl->nominal;
                    ...
                    <?php foreach($this->db->get_where('akuntansi_anak_akun', array('id_induk'=>$row->id_induk))->result() as $anak){?>
                      <!-- <tr>
                        ...
                        foreach($ts->result() as $akun){?>
                            ...
                            <!-- <td><?php echo "Rp. ".number_format($ttl_sld).$_jrl2?></td> -->
                            <?php 
                            // print_r($this->Dashboard_model->laba_rugi_pos($akun->no_akun, $kode_perumahan, "", $tglmin)->result());
                            // echo $tglmin;
                            $total=0; $db=0; $kr=0; foreach($this->Dashboard_model->laba_rugi_pos($akun->no_akun, $kode_perumahan, "", $tglmin)->result() as $pos){
                              if($pos->pos_akun == "kredit"){
                                $kr = $kr + $pos->nominal;
                              } else if($pos->pos_akun == "debet") {
                                $db = $db + $pos->nominal;
                ...
                <?php  $ttl_prive = 0; $kr=0; $db=0; if($tglmin != ""){?>
                <?php foreach($this->db->get_where('keuangan_neraca_saldo_awal', array('no_akun'=>"31003", 'kode_perumahan'=>$kode_perumahan))->result() as $prive1){?>
                  <!-- <tr style="background-color: pink">
                    <td><?php echo $prive->no_akun?></td>
                    <td colspan=2><?php echo $prive->nama_akun?></td>
                    <td><?php echo $prive->pos?></td> -->
                    <?php
                    foreach($this->Dashboard_model->perubahan_modal($prive1->no_akun, $kode_perumahan, "", $tglmin)->result() as $prb_prv){
                ...
                <?php foreach($this->db->get_where('keuangan_neraca_saldo_awal', array('no_akun'=>"31001", 'kode_perumahan'=>$kode_perumahan))->result() as $modal){?>
                  <tr style="background-color: pink">
                    <td style="background-color: pink"><?php echo $modal->no_akun?></td>
                    <td style="background-color: pink"><?php echo $modal->nama_akun?></td>
                    <td style="background-color: pink">AWAL</td>
                    <td style="background-color: pink"><?php echo $modal->pos?></td>

                    <?php 
                    $total_jr=0; $db=0; $kr=0; $total_jr2=0; $db1=0; $kr1=0; $ttl_sld=0; $kr_jrl1 = 0; $db_jrl1 = 0; $kr_jrl=0; $db_jrl=0;
                    if($tglmin != ""){
                      ?>
                      <?php 
                      foreach($this->Dashboard_model->laba_rugi_pos_jurnal($modal->no_akun, $kode_perumahan, "", $tglmin, "koreksi")->result() as $sld){
                ...
                <?php foreach($this->db->get_where('keuangan_neraca_saldo_awal', array('no_akun'=>"31003", 'kode_perumahan'=>$kode_perumahan))->result() as $prive){?>
                  <!-- <tr style="background-color: pink">
                    <td><?php echo $prive->no_akun?></td>
                    <td colspan=2><?php echo $prive->nama_akun?></td>
                    <td><?php echo $prive->pos?></td> -->
                    ...
                    if($tglmin != ""){
                      ?>
                      <?php 
                      foreach($this->Dashboard_model->laba_rugi_pos_jurnal($prive->no_akun, $kode_perumahan, "", $tglmin, "koreksi")->result() as $sld){
                        if($sld->pos_akun == "kredit"){
                          $kr_jrl = $kr_jrl + $sld->nominal;
                        } else if($sld->pos_akun == "debet") {
                          $db_jrl = $db_jrl + $sld->nominal;
                      ...
                      foreach($this->Dashboard_model->laba_rugi_pos_jurnal($prive->no_akun, $kode_perumahan, "", $tglmin, "penyesuaian")->result() as $sld1){
                        if($sld1->pos_akun == "kredit"){
                          $kr_jrl1 = $kr_jrl1 + $sld1->nominal;
                        } else if($sld1->pos_akun == "debet") {
                          $db_jrl1 = $db_jrl1 + $sld1->nominal;
                    ...
                    <?php foreach($this->Dashboard_model->laba_rugi_pos_jurnal($prive->no_akun, $kode_perumahan, $tglmin, $tglmax, "koreksi")->result() as $jrnl){
                      if($jrnl->pos_akun == "kredit"){
                        $kr = $kr + $jrnl->nominal;
                      } else if($jrnl->pos_akun == "debet") {
                        $db = $db + $jrnl->nominal;
                    ...
                    <?php foreach($this->Dashboard_model->laba_rugi_pos_jurnal($prive->no_akun, $kode_perumahan, $tglmin, $tglmax, "penyesuaian")->result() as $jrnl){
                      if($jrnl->pos_akun == "kredit"){
                        $kr1 = $kr1 + $jrnl->nominal;
                      } else if($jrnl->pos_akun == "debet") {
                        $db1 = $db1 + $jrnl->nominal;
                    ...
                    <?php $ttl_prive = 0; $kr=0; $db=0;
                    foreach($this->Dashboard_model->perubahan_modal($prive->no_akun, $kode_perumahan, $tglmin, $tglmax)->result() as $prb_prv){
                      if($prb_prv->pos_akun == "kredit"){
                        $kr = $kr + $prb_prv->nominal;
                      } else if($prb_prv->pos_akun == "debet"){
                        $db = $db + $prb_prv->nominal;
                      ...
                      <!-- <tr>
                        ...
                        <?php 
                          ...
                          foreach($ts->result() as $akun){?>
                            ...
                            <!-- <td><?php 
                            // $p1 = $p1 + $ttl_sld+$total+$total_jr+$total_jr2;
                            $p1 = $p1 + $total+$total_jr+$total_jr2;
                            $p6 = $p6 + $ttl_sld+$total+$total_jr+$total_jr2-$total_jr1;
                            echo "Rp. ".number_format($ttl_sld+$total+$total_jr+$total_jr2-$total_jr1);?>
                            </td> -->
                        <?php }} else {
                    ...
                    <?php foreach($this->db->get_where('akuntansi_anak_akun', array('id_induk'=>$row->id_induk))->result() as $anak){?>
                        <!-- <tr>
                            ...
                            foreach($ts->result() as $akun){?>
                                ...
                                <!-- <td><?php 
                                // $p2 = $p2 + $ttl_sld+$total+$total_jr+$total_jr2;
                                $p2 = $p2 +$total+$total_jr+$total_jr2;
                                $p7 = $p7 + $ttl_sld+$total+$total_jr+$total_jr2-$total_jr1;
                                echo "Rp. ".number_format($ttl_sld+$total+$total_jr+$total_jr2-$total_jr1);?></td> -->
                        <?php }} else {
                          // echo "<td></td><td></td><td></td><td></td><td></td><td></td><td></td>"; 
                    ...
                    <?php foreach($this->db->get_where('akuntansi_anak_akun', array('id_induk'=>$row->id_induk))->result() as $anak){?>
                        <!-- <tr>
                          ...
                          foreach($ts->result() as $akun){?>
                            ...
                            <td><?php 
                            // $p3 = $p3 + $ttl_sld+$total+$total_jr+$total_jr2;
                            $p3 = $p3 + $total+$total_jr+$total_jr2;
                            $p8 = $p8 + $ttl_sld+$total+$total_jr+$total_jr2+$total_jr1;
                            echo "Rp. ".number_format($ttl_sld+$total+$total_jr-$total_jr1+$total_jr2);?></td> -->
                        <?php }} else {
                          // echo "<td></td><td></td><td></td><td></td><td></td><td></td><td></td>";
                    ...
                    <?php foreach($this->db->get_where('akuntansi_anak_akun', array('id_induk'=>$row->id_induk))->result() as $anak){?>
                      <!-- <tr>
                        ...
                        foreach($ts->result() as $akun){?>
                            ...
                            <!-- <td><?php 
                            $p4 = $p4 + $total+$total_jr+$total_jr2;
                            $p9 = $p9 + $ttl_sld+$total+$total_jr+$total_jr2-$total_jr1;
                            echo "Rp. ".number_format($ttl_sld+$total+$total_jr+$total_jr2-$total_jr1);?></td> -->
                    <?php }} else {
                      // echo "<td></td><td></td><td></td><td></td><td></td><td></td><td></td>"; 
                    ...
                    <?php foreach($this->db->get_where('akuntansi_anak_akun', array('id_induk'=>$row->id_induk))->result() as $anak){?>
                      <!-- <tr> -->
                        ...
                        foreach($ts->result() as $akun){?>
                            ...
                            <?php 
                            // $p5 = $p5 + $ttl_sld+$total+$total_jr+$total_jr2;
                            $p5 = $p5 + $total+$total_jr+$total_jr2;
                            $p10 = $p10 + $ttl_sld+$total+$total_jr+$total_jr1+$total_jr2;
                            echo "Rp. ".number_format($ttl_sld+$total+$total_jr+$total_jr2-$total_jr1);?>
                            </td> -->
                        <?php }} else {
                ...
                <?php foreach($this->db->get_where('keuangan_neraca_saldo_awal', array('no_akun'=>"31001", 'kode_perumahan'=>$kode_perumahan))->result() as $modal){?>
                  <!-- <tr style="background-color: lightblue">
                    ...
                    <td style="background-color: pink"><?php echo "Rp. ".number_format($total_jr)?></td>
                    <td style="background-color: pink"><?php echo "Rp. ".number_format($total_jr1)?></td>
                    <td style="background-color: pink">
                      <?php echo "Rp. ".number_format((($p1-$p2-($p3+$p4)-$p5)-$ttl_prive)+$ttl_mdl_awal);?>
                    </td>
                  </tr>
                ...
                <?php $ttl4 = $ttl4 + (($p1-$p2-($p3+$p4)-$p5)-$ttl_prive)+$ttl_mdl_awal; }?>
                <tr style="background-color: pink; font-weight: bold">
                  <td style="text-align: center;" colspan=8>TOTAL PASSIVA</td>
                  <td><?php echo "Rp. ".number_format($ttl3+$ttl4);?></td>
                </tr>
              </tbody>
            </table>
        </div>
