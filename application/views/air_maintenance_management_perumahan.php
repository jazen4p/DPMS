    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>
              Rekap Laporan Air & Maintenance
            </h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url()?>Dashboard">Home</a></li>
              <li class="breadcrumb-item active">Rekap Air & Maintenance</li>
            </ol>
          </div>
        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="white-space: nowrap">
                                        <a href="<?php echo base_url()?>Dashboard/air_maintenance_report?id=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm">Buka</a>
                                    </td>
                                </tr>
                                <?php $no++;}?>
                            </tfoot>
