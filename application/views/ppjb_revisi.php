            ...
            <div class="col-md-12">
                ...
                <!-- form start -->
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            <form role="form" action="<?php echo base_url()?>Dashboard/ppjb_revisi" onsubmit="return myFunction()" method="post" enctype="multipart/form-data">
...
function myFunction() {
  ...
  if (r) {
    ...
    window.location.replace(base_url+"/ppjb_revisi");
  } else {
    return false;
  }
//   if (r == true) {
