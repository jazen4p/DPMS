          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-header">
                <div class="row">
                  <a href="<?php echo base_url()?>Dashboard/kavling_management" class="btn btn-success btn-sm">Kembali</a>
                </div>
                <!-- /.row -->
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <form action="<?php echo base_url()?>Dashboard/kavling_revisi_data" method="POST">
                    <div class="row">
                      <div class="col-sm-6">
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr><td>Biaya Pembersihan Lahan</td><td><?php echo $row->biaya_pembersihan?></td>
                            <tr><td>Biaya Balik Nama</td><td><?php echo $row->biaya_balik_nama?></td>
                            </tr>
                        </tbody>
                    </table>
                    <!-- /.chart-responsive -->
                  ...
                  <form action="<?php echo base_url()?>Dashboard/edit_kavling_dp" method="POST">
                    <div class="col-md-12">
                        ...
                        <table class="table">
                          ...
                          <tbody>
                              ...
                              <tr style="background-color: ">
                                  ...
                                  <td>
                                    <?php 
                                      if(isset($ttl_pembayaran)){
                                        echo "Rp. ".number_format($ttl_pembayaran);
                                      } else {
                                        echo "Rp. 0";
                                      }?>
                                  </td>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url()?>Dashboard/kavling_ubah_blok" method="POST">
          <div class="row">
            <div class="col-sm-6">
          ...
          <div class="form-group">
            ...
            <div id="id_kavling" style=" border:2px solid #ccc; width:100%; height: 75px; overflow-y: scroll;">
              ...
              $query = $this->db->get_where('rumah', array('kode_perumahan'=>$row->kode_perumahan, 'tipe_produk'=>"kavling", 'status'=>"free"))->result();
