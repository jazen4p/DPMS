          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a href="<?php echo base_url()?>Dashboard/bast_sub_dev_management?id=<?php echo $id?>" class="btn btn-success btn-sm">Kembali</a>
                    ...
                    foreach($this->db->get_where('kbk_termin', array('id_kbk'=>$row->id_kbk, 'tahap'=>"Termin 4"))->result() as $ters){
                      if($ters->realisasi_progress == 90){?>
                        <tr>
                          ...
                          <td>
                            <?php 
                              $gt = $this->db->get_where('bast', array('id_kbk'=>$row->id_kbk));
                              if($gt->num_rows() < 1){?>
                                <a href="<?php echo base_url()?>Dashboard/add_bast_sub_dev?id=<?php echo $row->id_kbk?>&kode=<?php echo $id?>" class="btn btn-sm btn-flat btn-outline-primary">Registrasi BAST</a>
                              <?php } else {
