                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a href="<?php echo base_url()?>Dashboard/management_pembelian_bahan" class="btn btn-success">Kembali</a>
                        </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                        <!-- <form role="form" action="<?php echo base_url()?>Dashboard/add_pengeluaran" method="post" enctype="multipart/form-data"> -->
                        <?php echo form_open_multipart('Dashboard/add_pembayaran_pembelian');?>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Terima oleh" name="terima_oleh" value="<?php echo $row->nama_toko?>" readonly required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <?php $hrg_ttl = 0; $ttl_utg = 0; 
                                            foreach($totalUtang->result() as $tl_utg){
                                            // $ttl_utg = $ttl_utg + $tl_utg->;
                                                $hrg_ttl = $tl_utg->qty*$tl_utg->harga_satuan;

                                                $ttl_utg = $ttl_utg + $hrg_ttl;
                                            }
                                            $ttl_byr = 0;
                                            foreach($this->db->get_where('keuangan_pengeluaran', array('no_pengeluaran'=>$row->no_faktur,'kode_perumahan'=>$row->kode_perumahan))->result() as $tl_pgl){
                                                $ttl_byr = $ttl_byr + $tl_pgl->nominal;
                                            }
                                        ?>
                                        <div class="form-group">
                                            <label>Total Pembelian</label>
                                            <input type="number" class="form-control" placeholder="NaN" id="totalPembelian" value="<?php echo $ttl_utg?>" readonly required>
                                        </div>
                                        <div class="form-group">
                                            <label>Total Terbayar</label>
                                            <input type="text" class="form-control" placeholder="NaN" id="totalByr" value="<?php echo $ttl_byr?>" readonly required>
                                        </div>
                                        <div class="form-group">
                                            <label>Nilai Pembayaran</label>
                                            <input type="number" class="form-control" placeholder="NaN" name="nilai_pengeluaran" id="nilaiPengeluaran" value="" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Sisa Utang</label>
                                            <input type="number" class="form-control" placeholder="NaN" id="sisaUtang" name="sisa_utang" value="<?php echo $ttl_utg-$ttl_byr?>" readonly required>
                                        </div>
                                    </div>
