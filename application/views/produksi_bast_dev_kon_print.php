        ...
        <?php foreach($this->db->get_where('kbk', array('id_kbk'=>$row->id_kbk))->result() as $kbk){?>
            <div>
                <div style="font-weight: bold; text-align: center">
                    <span style="font-size: 20px">BERITA ACARA SERAH TERIMA (BAST)</span> <br>
                ...
                <div>
                    ...
                    <span style="text-align: justify">Selanjutnya di dalam berita acara ini disebut <b>PIHAK KESATU</b>.</span>
                    <br> <br>
                    <table>
                        <tr>
                            <td>Nama</td>
                            <td style="padding-left: 50px">:</td>
                            <td style="padding-left: 10px"><?php echo $nama_pemesan?></td>
                        </tr>
                        <tr>
                            <td>Pekerjaan</td>
                            <td style="padding-left: 50px">:</td>
                            <td style="padding-left: 10px"><?php echo $pekerjaan?></td>
                        </tr>
                        <tr>
                            <td>Alamat</td>
                            <td style="padding-left: 50px">:</td>
                            <td style="padding-left: 10px"><?php echo $alamat_rumah?></td>
                        </tr>
                    </table>
                    <span style="text-align: justify">Selanjutnya di dalam berita acara ini disebut <b>PIHAK KEDUA</b>.</span>
                </div>
                    <br>
                <div style="text-align: justify">
                  Dengan ditandatanganinya Berita Acara Serah Terima Akhir Bangunan ini, kedua belah pihak telah saling sepakat sebagai berikut :
                </div>
                    <br>
                <div style="text-align: justify">
                  <ul type="1">
                    <li>PIHAK KEDUA telah menyerahkan bangunan rumah dalam keadaan baik beserta kunci rumah kepada PIHAK PERTAMA, dan PIHAK PERTAMA menerima dengan baik rumah tinggal yang dimaksud dari PIHAK KEDUA yang terletak di :</li>
                    <table>
                        <tr>
                            <td>-</td>
                            <td style="padding-left: 40px">Bangunan</td>
                        ...
                        <tr>
                            <td>-</td>
                            <td style="padding-left: 40px">Kavling</td>
                            <td style="padding-left: 40px">:</td>
                            <td style="padding-left: 10px"><?php echo $kbk->unit?></td>
                        </tr>
                        <tr>
                            <td>-</td>
                            <td style="padding-left: 40px">Luas Bangunan</td>
                            <td style="padding-left: 40px">:</td>
                            <td style="padding-left: 10px"><?php echo $kbk->luas_bangunan?> m2</td>
                        </tr>
                    </table>

                    <li>Sebelum dilakukan penandatanganan Berita Acara Serah Terima ini, PIHAK KEDUA sudah melakukan pemeriksaan-pemeriksaan atas semua keadaan bangunan tersebut dan menyatakan dalam keadaan baik dan setuju untuk menerima serah terima ini.</li>
                    <li>Dengan diserahkannya rumah tersebut butir 1 kepada PIHAK KEDUA, maka Pihak Pertama akan memberikan garansi perbaikan selama 30 (tiga puluh) hari sejak Berita Serah Acara Terima ini ditandatangani dan untuk selanjutnya tanggung-jawab perawatan, pemeliharaan dan keamanannya menjadi tanggung-jawab PIHAK KEDUA serta PIHAK KESATU tidak menerima komplain dalam bentuk apapun juga dari PIHAK KEDUA.</li>
                    <li>Berita Acara Serah Terima Akhir Bangunan ini dibuat bukan merupakan suatu bukti lunas pembayaran PIHAK KEDUA kepada PIHAK KESATU.</li>
                  </ul>
                </div>
                  <br>
                <div>
                Demikian Berita Acara Serah Terima Bangunan ini dibuat rangkap 3 (tiga), untuk dipergunakan sebagaimana mestinya.
                </div>
                  <br>
                <div style="page-break-inside: avoid">
                    <table style="table-layout: fixed; width: 100%; padding-left: 30px">
                        ...
                        <tr>
                            <td><u><?php echo strtoupper($nama_pemesan)?></u></td>
                            <td style="text-align: center"><u><?php echo strtoupper($kbk->dev_nama)?></u></td>
                            </tr>
                        <tr>
                            <td><?php echo "PEMBELI/MEWAKILI"?></td>
                            <td style="text-align: center"><?php echo "Head QC ".$as->nama_perumahan." Residence"?></td>
                        </tr>
                    </table>
                </div>
            </div>
