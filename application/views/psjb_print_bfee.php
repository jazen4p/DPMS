...
?>
    <?php foreach($check_all->result() as $row){?>
      ...
      <p>
        ...
        HP: 0813.2793.5678 
        <!-- <span style="text-align: right; padding-left: 450px; color: red">NO.KW.<?php echo $row->kode_perumahan."1".substr("000{$row->no_kwitansi}", -3)?></span><br/> -->
      </p>
    <hr>
   </div>
   <div id="footer">
   ...
   <div id="content">
             ...
             <table style="padding-left: 40px">
                 <tbody>
                    <tr>
                        ...
                        <th>:</th>
                        <th><?php echo $row->nama_pemesan?></th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th>:</th>
                        <th><?php echo terbilang($row->uang_awal)?> Rupiah</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th>
                          <?php 
                          echo "Uang Tanda Jadi / Booking Fee"?>
                        </th>
                    </tr>
                 </tbody>
             </table>
     ...
     <table style="width: 100%; table-layout: fixed">
          <tr>
            <td>
              <span style="width: 120px; border: 1px solid; padding: 5px; margin: 20px; margin-left: 40px; font-size: 18px; font-weight: bold">Rp. <?php echo number_format($row->uang_awal)?></span>                
            </td>
            <td style="text-align: center">
              Pontianak, <?php echo date('d', strtotime($row->tgl_psjb))." ".ubahBulan(date('M', strtotime($row->tgl_psjb)))." ".date('Y', strtotime($row->tgl_psjb))?>
            </td>
          </tr>
          <tr>
            <td></td>
        ...
        <!-- <span style="width: 120px; border: 1px solid; padding-left: 15px;padding-right: 15px;padding-top: 15px;padding-bottom: 15px; margin: 20px; margin-left: 40px; font-size: 18px; font-weight: bold">Rp. <?php echo number_format($row->uang_awal)?></span>
