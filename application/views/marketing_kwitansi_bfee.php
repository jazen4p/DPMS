        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Daftar Kwitansi BFee</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-striped" style="font-size: 13px">
                  ...
                  <div id="wrapper" style="">
                    <form action="<?php echo base_url()?>Dashboard/filter_daftar_kwitansi_bfee" method="POST">
                    Perumahan:
                  ...
                  <tbody style="white-space: nowrap">
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <?php foreach($this->db->get_where('rumah', array('no_psjb'=>$row->no_psjb, 'kode_perumahan'=>$row->kode_perumahan, 'tipe_produk'=>$row->tipe_produk))->result() as $rows){
                            echo ", ".$rows->kode_rumah;
                          }?>
                        </td>
                        <td><?php echo $row->created_by?></td>
                        <td><a href="<?php echo base_url()?>Dashboard/print_kwitansi_bfee?id=<?php echo $row->no_psjb?>&kav=<?php echo $row->tipe_produk?>&kode=<?php echo $row->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm" target="_blank">Cetak Kwitansi</a></td>
                    </tr>
                    <?php }?>

                    <?php foreach($check_all2->result() as $row1){?>
                      <tr>
                        <td><?php echo $row1->no_psjb?></td>
                        <td><?php echo $row1->kode_perumahan?></td>
                        <td><?php echo $row1->nama_pemesan?></td>
                        <td><?php echo $row1->nama_marketing?></td>
                        <td><?php echo $row1->pimpinan?></td>
                        <td><?php echo $row1->telp_hp?></td>
                        <td><?php echo $row1->sistem_pembayaran?></td>
                        <td><?php echo $row1->tgl_psjb?></td>
                        <td>
                          <?php echo $row1->no_kavling?>
                          <?php foreach($this->db->get_where('rumah', array('no_psjb'=>$row1->psjb, 'kode_perumahan'=>$row1->kode_perumahan, 'tipe_produk'=>$row1->tipe_produk))->result() as $row2){
                            echo ", ".$row2->kode_rumah;
                          }?>
                        </td>
                        <td><?php echo $row1->created_by?></td>
                        <td><a href="<?php echo base_url()?>Dashboard/print_kwitansi_bfee?id=<?php echo $row1->no_psjb?>&kav=<?php echo $row1->tipe_produk?>&kode=<?php echo $row1->kode_perumahan?>" class="btn btn-outline-primary btn-flat btn-sm" target="_blank">Cetak Kwitansi</a></td>
                      </tr>
                    <?php }?>
                  </tfoot>
                </table>
